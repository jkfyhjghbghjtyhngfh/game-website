 (window._gsQueue || (window._gsQueue = [])).push((function() {
    ...
    window._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], (function(t, e, a) {
        ...
        r.constructor = s,
        r.kill()._gc = !1,
        s.killTweensOf = s.killDelayedCallsTo = a.killTweensOf,
        s.getTweensOf = a.getTweensOf,
        s.ticker = a.ticker,
        ...
        r.updateTo = function(t, e) {
            var i, s = this.ratio;
            for (i in e && this.timeline && this._startTime < this._timeline._time && (this._startTime = this._timeline._time,
            this._uncache(!1),
            ...
            if (this._initted)
                if (e)
                    this._initted = !1;
                else if (this._notifyPluginsOfEnabled && this._firstPT && a._onPluginEvent("_onDisable", this),
                this._time / this._duration > .998) {
                    ...
                    this._initted = !1,
                    this._init();
                    for (var r, n = 1 / (1 - s), h = this._firstPT; h; )
                        r = h.s + h.c,
                        h.c *= n,
                        h.s = r - h.c,
                        h = h._next
        ...
        r.render = function(t, e, a) {
            var i, s, o, r, h, l, u, m = this._dirty ? this.totalDuration() : this._totalDuration, d = this._time, c = this._totalTime, g = this._cycle;
            if (t >= m ? (this._totalTime = m,
            ...
            this._reversed || (i = !0,
            s = "onComplete"),
            0 === this._duration && ((0 === t || 0 > this._rawPrevTime) && this._rawPrevTime !== t && (a = !0,
            this._rawPrevTime > 0 && (s = "onReverseComplete",
            e && (t = -1))),
            this._rawPrevTime = t)) : 1e-7 > t ? (this._totalTime = this._time = this._cycle = 0,
            this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0,
            (0 !== c || 0 === this._duration && this._rawPrevTime > 0) && (s = "onReverseComplete",
            i = this._reversed),
            0 > t ? (this._active = !1,
            0 === this._duration && (this._rawPrevTime >= 0 && (a = !0),
            this._rawPrevTime = t)) : this._initted || (a = !0)) : (this._totalTime = this._time = t,
            0 !== this._repeat && (r = this._duration + this._repeatDelay,
            ...
            d !== this._time || a) {
                ...
                for (this._active || !this._paused && this._time !== d && t >= 0 && (this._active = !0),
                0 === c && (this._startAt && (t >= 0 ? this._startAt.render(t, e, a) : s || (s = "_dummyGS")),
                this.vars.onStart && (0 !== this._totalTime || 0 === this._duration) && (e || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || n))),
                o = this._firstPT; o; )
                    o.f ? o.t[o.p](o.c * this.ratio + o.s) : o.t[o.p] = o.c * this.ratio + o.s,
                    o = o._next;
                this._onUpdate && (0 > t && this._startAt && this._startAt.render(t, e, a),
                e || this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || n)),
                this._cycle !== g && (e || this._gc || this.vars.onRepeat && this.vars.onRepeat.apply(this.vars.onRepeatScope || this, this.vars.onRepeatParams || n)),
                s && (this._gc || (0 > t && this._startAt && !this._onUpdate && this._startAt.render(t, e, a),
                i && (this._timeline.autoRemoveChildren && this._enabled(!1, !1),
                this._active = !1),
                !e && this.vars[s] && this.vars[s].apply(this.vars[s + "Scope"] || this, this.vars[s + "Params"] || n)))
            } else
                c !== this._totalTime && this._onUpdate && (e || this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || n))
        }
        ,
        s.to = function(t, e, a) {
            return new s(t,e,a)
        ...
        s.fromTo = function(t, e, a, i) {
            return i.startAt = a,
            i.immediateRender = 0 != i.immediateRender && 0 != a.immediateRender,
            new s(t,e,i)
        }
        ,
        s.staggerTo = s.allTo = function(t, e, r, h, l, u, m) {
            h = h || 0;
            var d, c, g, p, f = r.delay || 0, _ = [], I = function() {
                r.onComplete && r.onComplete.apply(r.onCompleteScope || this, arguments),
                l.apply(m || this, u || n)
            };
            for (t instanceof Array || ("string" == typeof t && (t = a.selector(t) || t),
            o(t) && (t = i.call(t, 0))),
            d = t.length,
            g = 0; d > g; g++) {
                for (p in c = {},
        ...
        s.isTweening = function(t) {
            for (var e, i = a.getTweensOf(t), s = i.length; --s > -1; )
                if ((e = i[s])._active || e._startTime === e._timeline._time && e._timeline._active)
                    return !0;
            return !1
        }
        ;
        var h = function(t, e) {
            for (var i = [], s = 0, o = t._first; o; )
                o instanceof a ? i[s++] = o : (e && (i[s++] = o),
                s = (i = i.concat(h(o, e))).length),
                o = o._next;
            return i
        }
        ...
        s.killAll = function(t, a, i, s) {
            null == a && (a = !0),
            null == i && (i = !0);
            var o, r, n, h = l(0 != s), u = h.length, m = a && i && s;
            for (n = 0; u > n; n++)
                r = h[n],
                (m || r instanceof e || (o = r.target === r.vars.onComplete) && i || a && !o) && (t ? r.totalTime(r.totalDuration()) : r._enabled(!1, !1))
        }
        ,
        s.killChildTweensOf = function(t, e) {
            if (null != t) {
                var r, n, h, l, u, m = a._tweenLookup;
                if ("string" == typeof t && (t = a.selector(t) || t),
                o(t) && (t = i(t, 0)),
                t instanceof Array)
                    for (l = t.length; --l > -1; )
                    ...
                    for (h in r = [],
                    m)
                        for (n = m[h].target.parentNode; n; )
                            n === t && (r = r.concat(m[h].tweens)),
                            n = n.parentNode;
                    for (u = r.length,
                    l = 0; u > l; l++)
                        e && r[l].totalTime(r[l].totalDuration()),
                        r[l]._enabled(!1, !1)
                }
            }
        }
        ...
        var u = function(t, a, i, s) {
            a = !1 !== a,
            i = !1 !== i;
            for (var o, r, n = l(s = !1 !== s), h = a && i && s, u = n.length; --u > -1; )
                r = n[u],
                (h || r instanceof e || (o = r.target === r.vars.onComplete) && i || a && !o) && r.paused(t)
        };
        ...
        s.globalTimeScale = function(e) {
            ...
            i._startTime = s - (s - i._startTime) * i._timeScale / e,
    ...
    window._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], (function(t, e, a) {
        var i = function(t) {
            e.call(this, t),
            this._labels = {},
            ...
            var a, i, s = this.vars;
            for (i in s)
                (a = s[i])instanceof Array && -1 !== a.join("").indexOf("{self}") && (s[i] = this._swapSelfInParams(a));
        ...
        h.staggerTo = function(t, e, s, r, h, l, u, m) {
            ...
            for ("string" == typeof t && (t = a.selector(t) || t),
            !(t instanceof Array) && t.length && t !== window && t[0] && (t[0] === window || t[0].nodeType && t[0].style && !t.nodeType) && (t = n.call(t, 0)),
            r = r || 0,
            d = 0; t.length > d; d++)
                s.startAt && (s.startAt = o(s.startAt)),
                c.to(t[d], e, o(s), d * r);
            return this.add(c, h)
        }
        ,
        h.staggerFrom = function(t, e, a, i, s, o, r, n) {
            return a.immediateRender = 0 != a.immediateRender,
            a.runBackwards = !0,
            this.staggerTo(t, e, a, i, s, o, r, n)
        }
        ,
        h.staggerFromTo = function(t, e, a, i, s, o, r, n, h) {
            return i.startAt = a,
            i.immediateRender = 0 != i.immediateRender && 0 != a.immediateRender,
            this.staggerTo(t, e, i, s, o, r, n, h)
        }
        ,
        ...
        h.set = function(t, e, i) {
            ...
            this.add(new a(t,0,e), i)
        }
        ,
        i.exportRoot = function(t, e) {
            null == (t = t || {}).smoothChildTiming && (t.smoothChildTiming = !0);
            var s, o, r = new i(t), n = r._timeline;
            for (null == e && (e = !0),
            n._remove(r, !0),
            r._startTime = 0,
            r._rawPrevTime = r._time = r._totalTime = n._time,
            s = n._first; s; )
                o = s._next,
                e && s instanceof a && s.target === s.vars.onComplete || r.add(s, s._startTime - s._delay),
                s = o;
            return n.add(r, 0),
            r
        }
        ...
        h.add = function(s, o, r, n) {
            ...
            !(s instanceof t)) {
                if (s instanceof Array) {
                    ...
                    l = s.length,
                    u = 0; l > u; u++)
                        (m = s[u])instanceof Array && (m = new i({
                            tweens: m
                        })),
                        this.add(m, h),
                        "string" != typeof m && "function" != typeof m && ("sequence" === r ? h = m._startTime + m.totalDuration() / m._timeScale : "start" === r && (m._startTime -= m.delay())),
                        h += n;
                ...
                if ("function" != typeof s)
                    throw "Cannot add " + s + " into the timeline; it is neither a tween, timeline, function, nor a string.";
                s = a.delayedCall(0, s)
            }
            if (e.prototype.add.call(this, s, o),
            this._gc && !this._paused && this._time === this._duration && this._time < this.duration())
                for (d = this; d._gc && d._timeline; )
                    d._timeline.smoothChildTiming ? d.totalTime(d._totalTime, !0) : d._enabled(!0, !1),
                    d = d._timeline;
            return this
        }
        ,
        ...
        h._remove = function(t, a) {
            return e.prototype._remove.call(this, t, a),
        ...
        h._parseTimeOrLabel = function(e, a, i, s) {
            ...
            if ("string" == typeof a)
                return this._parseTimeOrLabel(a, i && "number" == typeof e && null == this._labels[a] ? e - this.duration() : 0, i);
            if (a = a || 0,
            "string" != typeof e || !isNaN(e) && null == this._labels[e])
                null == e && (e = this.duration());
            else {
                if (-1 === (o = e.indexOf("=")))
                    return null == this._labels[e] ? i ? this._labels[e] = this.duration() + a : a : this._labels[e] + a;
                a = parseInt(e.charAt(o - 1) + "1", 10) * Number(e.substr(o + 1)),
        ...
        h.render = function(t, e, a) {
            ...
            var i, o, r, n, h, l = this._dirty ? this.totalDuration() : this._totalDuration, u = this._time, m = this._startTime, d = this._timeScale, c = this._paused;
            ...
            (0 !== u || 0 === this._duration && this._rawPrevTime > 0) && (n = "onReverseComplete",
            o = this._reversed),
            0 > t ? (this._active = !1,
            ...
            this._time !== u && this._first || a || h) {
                if (this._initted || (this._initted = !0),
                this._active || !this._paused && this._time !== u && t > 0 && (this._active = !0),
                0 === u && this.vars.onStart && 0 !== this._time && (e || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || s)),
                this._time >= u)
                    for (i = this._first; i && (r = i._next,
                    !this._paused || c); )
                        (i._active || i._startTime <= this._time && !i._paused && !i._gc) && (i._reversed ? i.render((i._dirty ? i.totalDuration() : i._totalDuration) - (t - i._startTime) * i._timeScale, e, a) : i.render((t - i._startTime) * i._timeScale, e, a)),
                        i = r;
                else
                    for (i = this._last; i && (r = i._prev,
                    !this._paused || c); )
                        (i._active || u >= i._startTime && !i._paused && !i._gc) && (i._reversed ? i.render((i._dirty ? i.totalDuration() : i._totalDuration) - (t - i._startTime) * i._timeScale, e, a) : i.render((t - i._startTime) * i._timeScale, e, a)),
                        i = r;
                this._onUpdate && (e || this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || s)),
                n && (this._gc || (m === this._startTime || d !== this._timeScale) && (0 === this._time || l >= this.totalDuration()) && (o && (this._timeline.autoRemoveChildren && this._enabled(!1, !1),
                this._active = !1),
                !e && this.vars[n] && this.vars[n].apply(this.vars[n + "Scope"] || this, this.vars[n + "Params"] || s)))
            }
        }
        ,
        ...
        h.getChildren = function(t, e, i, s) {
            s = s || -9999999999;
            for (var o = [], r = this._first, n = 0; r; )
                s > r._startTime || (r instanceof a ? !1 !== e && (o[n++] = r) : (!1 !== i && (o[n++] = r),
                !1 !== t && (n = (o = o.concat(r.getChildren(!0, e, i))).length))),
                r = r._next;
            return o
        }
        ,
        h.getTweensOf = function(t, e) {
            for (var i = a.getTweensOf(t), s = i.length, o = [], r = 0; --s > -1; )
                (i[s].timeline === this || e && this._contains(i[s])) && (o[r++] = i[s]);
            return o
        }
        ,
        ...
        h.shiftChildren = function(t, e, a) {
            a = a || 0;
            for (var i, s = this._first, o = this._labels; s; )
                s._startTime >= a && (s._startTime += t),
                s = s._next;
            if (e)
                for (i in o)
                    o[i] >= a && (o[i] += t);
        ...
        h._kill = function(t, e) {
            ...
            for (var a = e ? this.getTweensOf(e) : this.getChildren(!0, !0, !1), i = a.length, s = !1; --i > -1; )
                a[i]._kill(t, e) && (s = !0);
            return s
        }
        ,
            ...
            if (!arguments.length) {
                if (this._dirty) {
                    for (var e, a, i = 0, s = this._last, o = 999999999999; s; )
                        ...
                        o = 0),
                        (a = s._startTime + s._totalDuration / s._timeScale) > i && (i = a),
                        s = e;
    ...
    window._gsDefine("TimelineMax", ["TimelineLite", "TweenLite", "easing.Ease"], (function(t, e, a) {
        var i = function(e) {
            t.call(this, e),
            this._repeat = this.vars.repeat || 0,
            this._repeatDelay = this.vars.repeatDelay || 0,
        ...
        n.removeCallback = function(t, e) {
            if (t)
                if (null == e)
                    ...
                    for (var a = this.getTweensOf(t, !1), i = a.length, s = this._parseTimeOrLabel(e); --i > -1; )
                        a[i]._startTime === s && a[i]._enabled(!1, !1);
            return this
        }
        ,
        n.tweenTo = function(t, a) {
            ...
            r = new e(this,Math.abs(Number(n.time) - this._time) / this._timeScale || .001,n),
            n.onStart = function() {
                r.target.paused(!0),
                r.vars.time !== r.target.time() && r.duration(Math.abs(r.vars.time - r.target.time()) / r.target._timeScale),
                a.onStart && a.onStart.apply(a.onStartScope || r, a.onStartParams || s)
            }
            ,
            r
        }
        ...
        n.render = function(t, e, a) {
            this._gc && this._enabled(!0, !1);
            var i, o, r, n, h, l, u = this._dirty ? this.totalDuration() : this._totalDuration, m = this._duration, d = this._time, c = this._totalTime, g = this._startTime, p = this._timeScale, f = this._rawPrevTime, _ = this._paused, I = this._cycle;
            if (t >= u ? (this._locked || (this._totalTime = u,
            this._cycle = this._repeat),
            this._reversed || this._hasPausedChild() || (o = !0,
            n = "onComplete",
            0 === m && (0 === t || 0 > this._rawPrevTime) && this._rawPrevTime !== t && this._first && (h = !0,
            this._rawPrevTime > 0 && (n = "onReverseComplete"))),
            this._rawPrevTime = t,
            this._yoyo && 0 != (1 & this._cycle) ? this._time = t = 0 : (this._time = m,
            t = m + 1e-6)) : 1e-7 > t ? (this._locked || (this._totalTime = this._cycle = 0),
            this._time = 0,
            (0 !== d || 0 === m && this._rawPrevTime > 0 && !this._locked) && (n = "onReverseComplete",
            o = this._reversed),
            0 > t ? (this._active = !1,
            0 === m && this._rawPrevTime >= 0 && this._first && (h = !0),
            this._rawPrevTime = t) : (this._rawPrevTime = t,
            t = 0,
            this._initted || (h = !0))) : (this._time = this._rawPrevTime = t,
            this._locked || (this._totalTime = t,
            0 !== this._repeat && (l = m + this._repeatDelay,
            this._cycle = this._totalTime / l >> 0,
            0 !== this._cycle && this._cycle === this._totalTime / l && this._cycle--,
            this._time = this._totalTime - this._cycle * l,
            this._yoyo && 0 != (1 & this._cycle) && (this._time = m - this._time),
            this._time > m ? (this._time = m,
            t = m + 1e-6) : 0 > this._time ? this._time = t = 0 : t = this._time))),
            this._cycle !== I && !this._locked) {
                var v = this._yoyo && 0 != (1 & I)
                  ...
                  , w = this._rawPrevTime
                  , x = this._time;
                if (this._totalTime = I * m,
                I > this._cycle ? v = !v : this._totalTime += m,
                this._time = d,
                this._rawPrevTime = 0 === m ? f - 1e-5 : f,
                this._cycle = I,
                this._locked = !0,
                d = v ? 0 : m,
                this.render(d, e, 0 === m),
            ...
            if (this._time !== d && this._first || a || h) {
                ...
                0 === c && this.vars.onStart && 0 !== this._totalTime && (e || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || s)),
                this._time >= d)
                    for (i = this._first; i && (r = i._next,
                    !this._paused || _); )
                        (i._active || i._startTime <= this._time && !i._paused && !i._gc) && (i._reversed ? i.render((i._dirty ? i.totalDuration() : i._totalDuration) - (t - i._startTime) * i._timeScale, e, a) : i.render((t - i._startTime) * i._timeScale, e, a)),
                    ...
                    for (i = this._last; i && (r = i._prev,
                    !this._paused || _); )
                        (i._active || d >= i._startTime && !i._paused && !i._gc) && (i._reversed ? i.render((i._dirty ? i.totalDuration() : i._totalDuration) - (t - i._startTime) * i._timeScale, e, a) : i.render((t - i._startTime) * i._timeScale, e, a)),
                        i = r;
                this._onUpdate && (e || this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || s)),
                n && (this._locked || this._gc || (g === this._startTime || p !== this._timeScale) && (0 === this._time || u >= this.totalDuration()) && (o && (this._timeline.autoRemoveChildren && this._enabled(!1, !1),
                this._active = !1),
                !e && this.vars[n] && this.vars[n].apply(this.vars[n + "Scope"] || this, this.vars[n + "Params"] || s)))
            } else
                c !== this._totalTime && this._onUpdate && (e || this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || s))
        }
        ,
        n.getActive = function(t, e, a) {
            ...
            null == e && (e = !0),
            null == a && (a = !1);
            var i, s, o = [], n = this.getChildren(t, e, a), h = 0, l = n.length;
            for (i = 0; l > i; i++)
                (s = n[i])._paused || s._timeline._time >= s._startTime && s._timeline._time < s._startTime + s._totalDuration / s._timeScale && (r(s._timeline) || (o[h++] = s));
            return o
        }
        ,
        n.getLabelAfter = function(t) {
            t || 0 !== t && (t = this._time);
            var e, a = this.getLabelsArray(), i = a.length;
            for (e = 0; i > e; e++)
                if (a[e].time > t)
                    return a[e].name;
            return null
    ...
    h = function(t, e, o, r, h) {
        var l, u, m, d, c, g, p, f, _, I, v, D, y, b = t.length - 1, w = 0, x = t[0].a;
        for (l = 0; b > l; l++)
            u = (c = t[w]).a,
            m = c.d,
            d = t[w + 1].d,
            h ? (v = a[l],
            y = .25 * ((D = i[l]) + v) * e / (r ? .5 : s[l] || .5),
            f = m - ((g = m - (m - u) * (r ? .5 * e : 0 !== v ? y / v : 0)) + (((p = m + (d - m) * (r ? .5 * e : 0 !== D ? y / D : 0)) - g) * (3 * v / (v + D) + .5) / 4 || 0))) : f = m - ((g = m - .5 * (m - u) * e) + (p = m + .5 * (d - m) * e)) / 2,
            g += f,
            p += f,
            c.c = _ = g,
            c.b = 0 !== l ? x : x = c.a + .6 * (c.c - c.a),
            c.da = m - u,
            c.ca = _ - u,
            c.ba = x - u,
            o ? (I = n(u, x, _, m),
            t.splice(w, 1, I[0], I[1], I[2], I[3]),
            w += 4) : w++,
            x = p;
        (c = t[w]).b = x,
        c.c = x + .4 * (c.d - x),
    ...
    l = function(t, e, s, o) {
        var n, h, l, u, m, d, c = [];
        if (o)
            for (h = (t = [o].concat(t)).length; --h > -1; )
                "string" == typeof (d = t[h][e]) && "=" === d.charAt(1) && (t[h][e] = o[e] + Number(d.charAt(0) + d.substr(2)));
        if (0 > (n = t.length - 2))
            return c[0] = new r(t[0][e],0,0,t[-1 > n ? 0 : 1][e]),
            c;
        for (h = 0; n > h; h++)
            l = t[h][e],
            u = t[h + 1][e],
            ...
            a[h] = (a[h] || 0) + (u - l) * (u - l),
            i[h] = (i[h] || 0) + (m - u) * (m - u));
        return c[h] = new r(t[h][e],0,0,t[h + 1][e]),
        c
    }
    ,
    u = function(t, e, r, n, u, m) {
        var d, c, g, p, f, _, I, v, D = {}, y = [], b = m || t[0];
        for (c in u = "string" == typeof u ? "," + u + "," : ",x,y,z,left,top,right,bottom,marginTop,marginLeft,marginRight,marginBottom,paddingLeft,paddingTop,paddingRight,paddingBottom,backgroundPosition,backgroundPosition_y,",
        null == e && (e = 1),
        t[0])
            y.push(c);
        if (t.length > 1) {
        ...
        for (a.length = i.length = s.length = 0,
        d = y.length; --d > -1; )
            c = y[d],
            o[c] = -1 !== u.indexOf("," + c + ","),
            D[c] = l(t, c, o[c], m);
        ...
        if (!n) {
            for (d = y.length; --d > -1; )
                if (o[c])
                    for (_ = (g = D[y[d]]).length - 1,
                    p = 0; _ > p; p++)
                        f = g[p + 1].da / i[p] + g[p].da / a[p],
                        s[p] = (s[p] || 0) + f * f;
            for (d = s.length; --d > -1; )
                s[d] = Math.sqrt(s[d])
        }
        ...
        p = r ? 4 : 1; --d > -1; )
            ...
            h(g, e, r, n, o[c]),
            I && (g.splice(0, p),
            g.splice(g.length - p, p));
        return D
    }
    ,
    m = function(t, e, a) {
        var i, s, o, n, h, l, u, m, d, c, g, p = {}, f = "cubic" === (e = e || "soft") ? 3 : 2, _ = "soft" === e, I = [];
        if (_ && a && (t = [a].concat(t)),
        null == t || f + 1 > t.length)
        ...
        for (l = I.length; --l > -1; ) {
            ...
            m = t.length,
            u = 0; m > u; u++)
                i = null == a ? t[u][d] : "string" == typeof (g = t[u][d]) && "=" === g.charAt(1) ? a[d] + Number(g.charAt(0) + g.substr(2)) : Number(g),
                _ && u > 1 && m - 1 > u && (h[c++] = (i + h[c - 2]) / 2),
                h[c++] = i;
            for (m = c - f + 1,
            c = 0,
            u = 0; m > u; u += f)
                ...
                o = h[u + 2],
                n = 2 === f ? 0 : h[u + 3],
                h[c++] = g = 3 === f ? new r(i,s,o,n) : new r(i,(2 * s + i) / 3,(2 * s + o) / 3,o);
            h.length = c
        }
        return p
    }
    ...
    d = function(t, e, a) {
        for (var i, s, o, r, n, h, l, u, m, d, c, g = 1 / a, p = t.length; --p > -1; )
            ...
            i = s = 0,
            u = 1; a >= u; u++)
                i = s - (s = ((l = g * u) * l * r + 3 * (m = 1 - l) * (l * n + m * h)) * l),
                e[c = p * a + u - 1] = (e[c] || 0) + i * i
    }
    ,
    c = function(t, e) {
        var a, i, s, o = [], r = [], n = 0, h = 0, l = (e = e >> 0 || 6) - 1, u = [], m = [];
        for (a in t)
            d(t[a], o, e);
        for (i = 0; 0 > i; i++)
            n += Math.sqrt(o[i]),
    ...
    g = window._gsDefine.plugin({
        ...
        init: function(t, e, a) {
            ...
            var i, s, o, r, n, h = e.values || [], l = {}, d = h[0], g = e.autoRotate || a.vars.orientToBezier;
            for (i in this._autoRotate = g ? g instanceof Array ? g : [["x", "y", "rotation", !0 === g ? 0 : Number(g) || 0]] : null,
            d)
                this._props.push(i);
            for (o = this._props.length; --o > -1; )
                i = this._props[o],
                this._overwriteProps.push(i),
                s = this._func[i] = "function" == typeof t[i],
                l[i] = s ? t[i.indexOf("set") || "function" != typeof t["get" + i.substr(3)] ? i : "get" + i.substr(3)]() : parseFloat(t[i]),
                n || l[i] !== h[0][i] && (n = l);
            if (this._beziers = "cubic" !== e.type && "quadratic" !== e.type && "soft" !== e.type ? u(h, isNaN(e.curviness) ? 1 : e.curviness, !1, "thruBasic" === e.type, e.correlate, n) : m(h, e.type, l),
        ...
        set: function(e) {
            var a, i, s, o, r, n, h, l, u, m, d = this._segCount, c = this._func, g = this._target;
            if (this._timeRes) {
                if (u = this._lengths,
                m = this._curSeg,
                e *= this._length,
                ...
                e > this._l2 && d - 1 > s) {
                    ...
                    this._l1 = u[s - 1],
                    this._li = s,
                    this._curSeg = m = this._segments[s],
                ...
                n = (e - (a = 0 > e ? 0 : e >= 1 ? d - 1 : d * e >> 0) * (1 / d)) * d;
            for (i = 1 - n,
            s = this._props.length; --s > -1; )
                o = this._props[s],
                h = (n * n * (r = this._beziers[o][a]).da + 3 * i * (n * r.ca + i * r.ba)) * n + r.a,
                this._round[o] && (h = h + (h > 0 ? .5 : -.5) >> 0),
                c[o] ? g[o](h) : g[o] = h;
            if (this._autoRotate) {
                ...
                for (s = b.length; --s > -1; )
                    ...
                    D = b[s][3] || 0,
                    y = !0 === b[s][4] ? 1 : t,
                    r = this._beziers[b[s][0]],
                    p = this._beziers[b[s][1]],
                    r && p && (r = r[a],
                    p = p[a],
                    f = r.a + (r.b - r.a) * n,
                    f += ((I = r.b + (r.c - r.b) * n) - f) * n,
                    I += (r.c + (r.d - r.c) * n - I) * n,
                    _ = p.a + (p.b - p.a) * n,
                    _ += ((v = p.b + (p.c - p.b) * n) - _) * n,
                    v += (p.c + (p.d - p.c) * n - v) * n,
                    h = Math.atan2(v - _, I - f) * y + D,
                    c[o] ? g[o](h) : g[o] = h)
            }
        }
    }),
    ...
    g._autoCSS = !0,
    g.quadraticToCubic = function(t, e, a) {
        ...
        if (t) {
            ...
            a._registerComplexSpecialProp("bezier", {
                parser: function(t, a, r, n, h, l) {
                    ...
                    l = new g;
                    var u, m, d, c = a.values, p = c.length - 1, f = [], _ = {};
                    if (0 > p)
                        return h;
                    for (u = 0; p >= u; u++)
                        d = i(t, c[u], n, h, l, p !== u),
                    ...
                    for (m in a)
                        _[m] = a[m];
                    return _.values = f,
                    (h = new o(t,"bezier",0,0,d.pt,2)).data = d,
                    h.plugin = l,
                    h.setRatio = s,
                    0 === _.autoRotate && (_.autoRotate = !0),
                    !_.autoRotate || _.autoRotate instanceof Array || (u = !0 === _.autoRotate ? 0 : Number(_.autoRotate) * e,
                    _.autoRotate = null != d.end.left ? [["left", "top", "rotation", u, !0]] : null != d.end.x && [["x", "y", "rotation", u, !0]]),
                    _.autoRotate && (n._transform || n._enableTransforms(!1),
                    d.autoRotate = n._target._gsTransform),
                    l._onInitTween(d.proxy, _, n._tween),
                    h
                }
            })
        }
    ...
    p._roundProps = function(t, e) {
        for (var a = this._overwriteProps, i = a.length; --i > -1; )
            (t[a[i]] || t.bezier || t.bezierThrough) && (this._round[a[i]] = e)
    }
    ,
    p._kill = function(t) {
    ...
    window._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], (function(t, e) {
        ...
        var l, u, m, d, c, g, p = /(?:\d|\-\d|\.\d|\-\.\d)+/g, f = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, _ = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, I = /[^\d\-\.]/g, v = /(?:\d|\-|\+|=|#|\.)*/g, D = /opacity *= *([^)]*)/, y = /opacity:([^;]*)/, b = /alpha\(opacity *=.+?\)/i, w = /^(rgb|hsl)/, x = /([A-Z])/g, S = /-([a-z])/gi, A = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, T = function(t, e) {
            return e.toUpperCase()
        }, P = /(?:Left|Right|Width)/i, E = /(M11|M12|M21|M22)=[\d\-\.e]+/gi, M = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i, k = /,(?=[^\)]*(?:\(|$))/gi, H = Math.PI / 180, L = 180 / Math.PI, B = {}, C = document, G = C.createElement("div"), F = C.createElement("img"), N = r._internals = {
            _specialProps: n
        }, Y = navigator.userAgent, R = function() {
            var t, e = Y.indexOf("Android"), a = C.createElement("div");
            return m = -1 !== Y.indexOf("Safari") && -1 === Y.indexOf("Chrome") && (-1 === e || Number(Y.substr(e + 8, 1)) > 3),
            c = m && 6 > Number(Y.substr(Y.indexOf("Version/") + 8, 1)),
            d = -1 !== Y.indexOf("Firefox"),
            /MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(Y),
            g = parseFloat(RegExp.$1),
            a.innerHTML = "<a style='top:1px;opacity:.55;'>a</a>",
            !!(t = a.getElementsByTagName("a")[0]) && /^0.55/.test(t.style.opacity)
        }(), O = function(t) {
            ...
            i = 5; --i > -1 && void 0 === s[a[i] + t]; )
                ;
            return i >= 0 ? (X = "-" + (W = 3 === i ? "ms" : a[i]).toLowerCase() + "-",
            W + t) : null
        }, q = C.defaultView ? C.defaultView.getComputedStyle : function() {}
        , z = r.getStyle = function(t, e, a, i, s) {
            var o;
            return R || "opacity" !== e ? (!i && t.style[e] ? o = t.style[e] : (a = a || q(t, null)) ? o = (t = a.getPropertyValue(e.replace(x, "-$1").toLowerCase())) || a.length ? t : a[e] : t.currentStyle && (o = t.currentStyle[e]),
            null == s || o && "none" !== o && "auto" !== o && "auto auto" !== o ? o : s) : O(t)
        }
        , j = function(t, e, a, i, s) {
            ...
            if ("auto" === i || !a)
                return 0;
            var o, r = P.test(e), n = t, h = G.style, l = 0 > a;
            return l && (a = -a),
            "%" === i && -1 !== e.indexOf("border") ? o = a / 100 * (r ? t.clientWidth : t.clientHeight) : (h.cssText = "border-style:solid; border-width:0; position:absolute; line-height:0;",
            "%" !== i && n.appendChild ? h[r ? "borderLeftWidth" : "borderTopWidth"] = a + i : (n = t.parentNode || C.body,
            h[r ? "width" : "height"] = a + i),
            n.appendChild(G),
            o = parseFloat(G[r ? "offsetWidth" : "offsetHeight"]),
            n.removeChild(G),
            0 !== o || s || (o = j(t, e, a, i, !0))),
            l ? -o : o
        }, K = function(t, e, a) {
            if ("absolute" !== z(t, "position", a))
                return 0;
            ...
            if (e = e || q(t, null))
                if (a = e.length)
                    for (; --a > -1; )
                        s[e[a].replace(S, T)] = e.getPropertyValue(e[a]);
                else
                    for (a in e)
                        s[a] = e[a];
                ...
                for (a in e)
                    s[a.replace(S, T)] = e[a];
            return R || (s.opacity = O(t)),
            i = wt(t, e, !1),
            s.rotation = i.rotation * L,
            s.skewX = i.skewX * L,
            s.scaleX = i.scaleX,
            s.scaleY = i.scaleY,
            s.x = i.x,
            s.y = i.y,
            bt && (s.z = i.z,
            s.rotationX = i.rotationX * L,
            s.rotationY = i.rotationY * L,
            s.scaleZ = i.scaleZ),
            s.filters && delete s.filters,
            s
        }, Z = function(t, e, a, i, s) {
            var o, r, n, h = {}, l = t.style;
            for (r in a)
                "cssText" !== r && "length" !== r && isNaN(r) && (e[r] !== (o = a[r]) || s && s[r]) && -1 === r.indexOf("Origin") && ("number" == typeof o || "string" == typeof o) && (h[r] = "auto" !== o || "left" !== r && "top" !== r ? "" !== o && "auto" !== o && "none" !== o || "string" != typeof e[r] || "" === e[r].replace(I, "") ? o : 0 : K(t, r),
                void 0 !== l[r] && (n = new mt(l,r,l[r],n)));
            if (i)
                for (r in i)
                    "className" !== r && (h[r] = i[r]);
            return {
            ...
            width: ["Left", "Right"],
            height: ["Top", "Bottom"]
        }, J = ["marginLeft", "marginRight", "marginTop", "marginBottom"], tt = function(t, e, a) {
            var i = parseFloat("width" === e ? t.offsetWidth : t.offsetHeight)
              , s = $[e]
              , o = s.length;
            for (a = a || q(t, null); --o > -1; )
                i -= parseFloat(z(t, "padding" + s[o], a, !0)) || 0,
                i -= parseFloat(z(t, "border" + s[o] + "Width", a, !0)) || 0;
            return i
        }, et = function(t, e) {
            ...
            e.oxr = "=" === i.charAt(1),
            e.oyr = "=" === s.charAt(1),
            e.ox = parseFloat(i.replace(I, "")),
            e.oy = parseFloat(s.replace(I, ""))),
            i + " " + s + (a.length > 2 ? " " + a[2] : "")
        }, at = function(t, e) {
            ...
            var s, o, r, n, h = 1e-6;
            return null == t ? n = e : "number" == typeof t ? n = t * H : (s = 2 * Math.PI,
            o = t.split("_"),
            r = Number(o[0].replace(I, "")) * (-1 === t.indexOf("rad") ? H : 1) - ("=" === t.charAt(1) ? 0 : e),
            o.length && (i && (i[a] = e + r),
            -1 !== t.indexOf("short") && ((r %= s) !== r % (s / 2) && (r = 0 > r ? r + s : r - s)),
            -1 !== t.indexOf("_cw") && 0 > r ? r = (r + 9999999999 * s) % s - (0 | r / s) * s : -1 !== t.indexOf("ccw") && r > 0 && (r = (r - 9999999999 * s) % s - (0 | r / s) * s)),
            n = e + r),
            h > n && n > -h && (n = 0),
            n
        }, ot = {
            ...
            i = t.charAt(3),
            t = "#" + e + e + a + a + i + i),
            [(t = parseInt(t.substr(1), 16)) >> 16, 255 & t >> 8, 255 & t]) : "hsl" === t.substr(0, 3) ? (t = t.match(p),
            s = Number(t[0]) % 360 / 360,
            o = Number(t[1]) / 100,
            e = 2 * (r = Number(t[2]) / 100) - (a = .5 >= r ? r * (o + 1) : r + o - r * o),
            t.length > 3 && (t[3] = Number(t[3])),
            t[0] = rt(s + 1 / 3, e, a),
            t[1] = rt(s, e, a),
            t[2] = rt(s - 1 / 3, e, a),
            t) : ((t = t.match(p) || ot.transparent)[0] = Number(t[0]),
            t[1] = Number(t[1]),
            t[2] = Number(t[2]),
            t.length > 3 && (t[3] = Number(t[3])),
            t)) : ot.black
        ...
        var lt = function(t, e, a, i) {
            if (null == t)
                ...
                ;
            var s, o = e ? (t.match(ht) || [""])[0] : "", r = t.split(o).join("").match(_) || [], n = t.substr(0, t.indexOf(r[0])), h = ")" === t.charAt(t.length - 1) ? ")" : "", l = -1 !== t.indexOf(" ") ? " " : ",", u = r.length, m = u > 0 ? r[0].replace(p, "") : "";
            return u ? s = e ? function(t) {
                var e, d, c, g;
                if ("number" == typeof t)
                    t += m;
                else if (i && k.test(t)) {
                    for (g = t.replace(k, "|").split("|"),
                    c = 0; g.length > c; c++)
                        g[c] = s(g[c]);
                    return g.join(",")
                }
                if (e = (t.match(ht) || [o])[0],
                c = (d = t.split(e).join("").match(_) || []).length,
                u > c--)
                    for (; u > ++c; )
                        d[c] = a ? d[0 | (c - 1) / 2] : r[c];
          ...
          , ut = function(t) {
            ...
            function(e, a, i, s, o, r, n) {
                ...
                for (n = {},
                h = 0; 4 > h; h++)
                    n[t[h]] = l[h] = l[h] || l[(h - 1) / 2 >> 0];
                return s.parse(e, n, o, r)
            }
        }
          , mt = (N._setPluginRatio = function(t) {
            this.plugin.setRatio(t);
            for (var e, a, i, s, o = this.data, r = o.proxy, n = o.firstMPT, h = 1e-6; n; )
                e = r[n.v],
                n.r ? e = e > 0 ? 0 | e + .5 : 0 | e - .5 : h > e && e > -h && (e = 0),
                n.t[n.p] = e,
                n = n._next;
        ...
        function(t, e, a, i, s) {
          ...
          , dt = (N._parseToProxy = function(t, e, a, i, s, o) {
            var r, n, h, l, u, m = i, d = {}, c = {}, g = a._transform, p = B;
            for (a._transform = null,
            B = e,
            i = u = a.parse(t, e, i, s),
            B = p,
            o && (a._transform = g,
            m && (m._prev = null,
            m._prev && (m._prev._next = null))); i && i !== m; ) {
                if (1 >= i.type && (c[n = i.p] = i.s + i.c,
                d[n] = i.s,
                o || (l = new mt(i,"s",n,l,i.r),
                i.c = 0),
                1 === i.type))
                    for (r = i.l; --r > 0; )
                        h = "xn" + r,
                        c[n = i.p + "_" + h] = i.data[h],
                        d[n] = i[h],
                        o || (l = new mt(i,h,n,l,i.rxp[h]));
                i = i._next
            }
            return {
                proxy: d,
        ...
        N.CSSPropTween = function(t, e, i, s, r, n, h, l, u, m, d) {
            ...
            this.c = s,
            this.n = h || e,
            t instanceof dt || o.push(this.n),
            this.r = l,
            this.type = n || 0,
            u && (this.pr = u,
            a = !0),
            this.b = void 0 === m ? i : m,
            this.e = void 0 === d ? i + s : d,
            r && (this._next = r,
            r._prev = this)
        }
        )
          , ct = r.parseComplex = function(t, e, a, i, s, o, r, n, h, u) {
            r = new dt(t,e,0,0,r,u ? 2 : 1,null,!1,n,a = a || o || "",i),
            i += "";
            var m, d, c, g, _, I, v, D, y, b, x, S, A = a.split(", ").join(",").split(" "), T = i.split(", ").join(",").split(" "), P = A.length, E = !1 !== l;
            for ((-1 !== i.indexOf(",") || -1 !== a.indexOf(",")) && (A = A.join(" ").replace(k, ", ").split(" "),
            T = T.join(" ").replace(k, ", ").split(" "),
            P = A.length),
            P !== T.length && (P = (A = (o || "").split(" ")).length),
            r.plugin = h,
            r.setRatio = u,
            m = 0; P > m; m++)
                if (g = A[m],
                _ = T[m],
                (D = parseFloat(g)) || 0 === D)
                    r.appendXtra("", D, at(_, D), _.replace(f, ""), E && -1 !== _.indexOf("px"), !0);
                else if (s && ("#" === g.charAt(0) || ot[g] || w.test(g)))
                    S = "," === _.charAt(_.length - 1) ? ")," : ")",
                    g = nt(g),
                    _ = nt(_),
                    (y = g.length + _.length > 6) && !R && 0 === _[3] ? (r["xs" + r.l] += r.l ? " transparent" : "transparent",
                    r.e = r.e.split(T[m]).join("transparent")) : (R || (y = !1),
                    r.appendXtra(y ? "rgba(" : "rgb(", g[0], _[0] - g[0], ",", !0, !0).appendXtra("", g[1], _[1] - g[1], ",", !0).appendXtra("", g[2], _[2] - g[2], y ? "," : S, !0),
                    y && (g = 4 > g.length ? 1 : g[3],
                    r.appendXtra("", g, (4 > _.length ? 1 : _[3]) - g, S, !1)));
                else if (I = g.match(p)) {
                    if (!(v = _.match(f)) || v.length !== I.length)
                        return r;
                    for (c = 0,
                    d = 0; I.length > d; d++)
                        x = I[d],
                        b = g.indexOf(x, c),
                        r.appendXtra(g.substr(c, b - c), Number(x), at(v[d], x), "", E && "px" === g.substr(b + x.length, 2), 0 === d),
                        c = b + x.length;
                    r["xs" + r.l] += g.substr(c)
                } else
                    r["xs" + r.l] += r.l ? " " + g : g;
            if (-1 !== i.indexOf("=") && r.data) {
                for (S = r.xs0 + r.data.s,
                m = 1; r.l > m; m++)
                    S += r["xs" + m] + r.data["xn" + m];
                r.e = S + r["xs" + m]
            }
            return r.l || (r.type = -1,
            r.xs0 = r.e),
          ...
          , gt = 9;
        for ((h = dt.prototype).l = h.pr = 0; --gt > 0; )
            h["xn" + gt] = 0,
            h["xs" + gt] = "";
        h.xs0 = "",
        h._next = h._prev = h.xfirst = h.data = h.plugin = h.setRatio = h.rxp = null,
        h.appendXtra = function(t, e, a, i, s, o) {
            var r = this
              , n = r.l;
            return r["xs" + n] += o && n ? " " + t : t || "",
            a || 0 === n || r.plugin ? (r.l++,
            ...
            r.rxp["xn" + n] = s,
            r["xn" + n] = e,
            r.plugin || (r.xfirst = new dt(r,"xn" + n,e,a,r.xfirst || r,0,r.n,s,r.pr),
            r.xfirst.xs0 = 0),
            r) : (r.data = {
                s: e + a
            },
        ...
        var pt = function(t, e) {
          ...
          , ft = N._registerComplexSpecialProp = function(t, e, a) {
            ...
            var i, s = t.split(","), o = e.defaultValue;
            for (a = a || [o],
            i = 0; s.length > i; i++)
                e.prefix = 0 === i && e.prefix,
                e.defaultValue = a[i] || o,
                new pt(s[i],e)
        }
          , _t = function(t) {
            if (!n[t]) {
                ...
                ft(t, {
                    parser: function(t, a, i, s, o, r, h) {
                        ...
                        n[i].parse(t, a, i, s, o, r, h)) : (U("Error: " + e + " js file not loaded."),
                        o)
                    }
                })
            }
        ...
        (h = pt.prototype).parseComplex = function(t, e, a, i, s, o) {
            ...
            if (this.multi && (k.test(a) || k.test(e) ? (n = e.replace(k, "|").split("|"),
            h = a.replace(k, "|").split("|")) : m && (n = [e],
            h = [a])),
            h) {
                for (l = h.length > n.length ? h.length : n.length,
                r = 0; l > r; r++)
                    e = n[r] = n[r] || this.dflt,
                    a = h[r] = h[r] || this.dflt,
                    m && (e.indexOf(m) !== (u = a.indexOf(m)) && ((a = -1 === u ? h : n)[r] += " " + m));
                e = n.join(", "),
                a = h.join(", ")
            }
        ...
        var It = "scaleX,scaleY,scaleZ,x,y,z,skewX,rotation,rotationX,rotationY,perspective".split(",")
          ...
          , wt = function(t, e, a, i) {
            if (t._gsTransform && a && !i)
                return t._gsTransform;
            var s, o, n, h, l, u, m, d, c, g, p, f, _, I = a && t._gsTransform || {
                skewY: 0
            }, v = 0 > I.scaleX, D = 2e-5, y = 1e5, b = 1e-4 - Math.PI, w = Math.PI - 1e-4, x = bt && (parseFloat(z(t, yt, e, !1, "0 0 0").split(" ")[2]) || I.zOrigin) || 0;
            for (vt ? s = z(t, Dt, e, !0) : t.currentStyle && (s = (s = t.currentStyle.filter.match(E)) && 4 === s.length ? [s[0].substr(4), Number(s[2].substr(4)), Number(s[1].substr(4)), s[3].substr(4), I.x || 0, I.y || 0].join(",") : ""),
            n = (o = (s || "").match(/(?:\-|\b)[\d\-\.e]+\b/gi) || []).length; --n > -1; )
                h = Number(o[n]),
                o[n] = (l = h - (h |= 0)) ? (0 | l * y + (0 > l ? -.5 : .5)) / y + h : h;
            if (16 === o.length) {
                var S = o[8]
                  , A = o[9]
                  , T = o[10]
                  ...
                  , M = o[13]
                  , k = o[14];
                if (I.zOrigin && (P = S * (k = -I.zOrigin) - o[12],
                M = A * k - o[13],
                k = T * k + I.zOrigin - o[14]),
                !a || i || null == I.rotationX) {
                    var H, L, B, C, G, F, N, Y = o[0], R = o[1], O = o[2], U = o[3], X = o[4], W = o[5], V = o[6], q = o[7], j = o[11], K = I.rotationX = Math.atan2(V, T), Q = b > K || K > w;
                    K && (H = X * (C = Math.cos(-K)) + S * (G = Math.sin(-K)),
                    L = W * C + A * G,
                    B = V * C + T * G,
                    S = X * -G + S * C,
                    A = W * -G + A * C,
                    ...
                    W = L,
                    V = B),
                    (K = I.rotationY = Math.atan2(S, Y)) && (F = b > K || K > w,
                    L = R * (C = Math.cos(-K)) - A * (G = Math.sin(-K)),
                    B = O * C - T * G,
                    A = R * G + A * C,
                    T = O * G + T * C,
                    j = U * G + j * C,
                    ...
                    R = L,
                    O = B),
                    (K = I.rotation = Math.atan2(R, W)) && (N = b > K || K > w,
                    Y = Y * (C = Math.cos(-K)) + X * (G = Math.sin(-K)),
                    L = R * C + W * G,
                    W = R * -G + W * C,
                    V = O * -G + V * C,
                    R = L),
                    N && Q ? I.rotation = I.rotationX = 0 : N && F ? I.rotation = I.rotationY = 0 : F && Q && (I.rotationY = I.rotationX = 0),
                    I.scaleX = (0 | Math.sqrt(Y * Y + R * R) * y + .5) / y,
                    I.scaleY = (0 | Math.sqrt(W * W + A * A) * y + .5) / y,
                    I.scaleZ = (0 | Math.sqrt(V * V + T * T) * y + .5) / y,
                    I.skewX = 0,
                    I.perspective = j ? 1 / (0 > j ? -j : j) : 0,
                    I.x = P,
                    I.y = M,
                    I.z = k
                }
                ...
                I.y = o[5] || 0,
                u = Math.sqrt($ * $ + J * J),
                m = Math.sqrt(et * et + tt * tt),
                d = $ || J ? Math.atan2(J, $) : I.rotation || 0,
                c = tt || et ? Math.atan2(tt, et) + d : I.skewX || 0,
                g = u - Math.abs(I.scaleX || 0),
                p = m - Math.abs(I.scaleY || 0),
                Math.abs(c) > Math.PI / 2 && Math.abs(c) < 1.5 * Math.PI && (v ? (u *= -1,
                c += 0 >= d ? Math.PI : -Math.PI,
                d += 0 >= d ? Math.PI : -Math.PI) : (m *= -1,
                c += 0 >= c ? Math.PI : -Math.PI)),
                f = (d - I.rotation) % Math.PI,
                _ = (c - I.skewX) % Math.PI,
                (void 0 === I.skewX || g > D || -D > g || p > D || -D > p || f > b && w > f && !1 | f * y || _ > b && w > _ && !1 | _ * y) && (I.scaleX = u,
                I.scaleY = m,
                I.rotation = d,
                I.skewX = c),
                bt && (I.rotationX = I.rotationY = I.z = 0,
                I.perspective = parseFloat(r.defaultTransformPerspective) || 0,
                I.scaleZ = 1)
            }
            for (n in I.zOrigin = x,
            I)
                D > I[n] && I[n] > -D && (I[n] = 0);
            return a && (t._gsTransform = I),
            I
        }
          , xt = function(t) {
            var e, a, i = this.data, s = -i.rotation, o = s + i.skewX, r = 1e5, n = (0 | Math.cos(s) * i.scaleX * r) / r, h = (0 | Math.sin(s) * i.scaleX * r) / r, l = (0 | Math.sin(o) * -i.scaleY * r) / r, u = (0 | Math.cos(o) * i.scaleY * r) / r, m = this.t.style, d = this.t.currentStyle;
            if (d) {
                a = h,
                h = -l,
                l = -a,
                e = d.filter,
                m.filter = "";
                var c, p, f = this.t.offsetWidth, _ = this.t.offsetHeight, I = "absolute" !== d.position, y = "progid:DXImageTransform.Microsoft.Matrix(M11=" + n + ", M12=" + h + ", M21=" + l + ", M22=" + u, b = i.x, w = i.y;
                if (null != i.ox && (b += (c = (i.oxp ? .01 * f * i.ox : i.ox) - f / 2) - (c * n + (p = (i.oyp ? .01 * _ * i.oy : i.oy) - _ / 2) * h),
                w += p - (c * l + p * u)),
                I)
                    y += ", Dx=" + ((c = f / 2) - (c * n + (p = _ / 2) * h) + b) + ", Dy=" + (p - (c * l + p * u) + w) + ")";
                else {
                    var x, S, A, T = 8 > g ? 1 : -1;
                    for (c = i.ieOffsetX || 0,
                    p = i.ieOffsetY || 0,
                    i.ieOffsetX = Math.round((f - ((0 > n ? -n : n) * f + (0 > h ? -h : h) * _)) / 2 + b),
                    i.ieOffsetY = Math.round((_ - ((0 > u ? -u : u) * _ + (0 > l ? -l : l) * f)) / 2 + w),
                    gt = 0; 4 > gt; gt++)
                        A = (a = -1 !== (x = d[S = J[gt]]).indexOf("px") ? parseFloat(x) : j(this.t, S, parseFloat(x), x.replace(v, "")) || 0) !== i[S] ? 2 > gt ? -i.ieOffsetX : -i.ieOffsetY : 2 > gt ? c - i.ieOffsetX : p - i.ieOffsetY,
                        m[S] = (i[S] = Math.round(a - A * (0 === gt || 2 === gt ? 1 : T))) + "px";
                    y += ", sizingMethod='auto expand')"
                }
                m.filter = -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? e.replace(M, y) : y + " " + e,
                (0 === t || 1 === t) && 1 === n && 0 === h && 0 === l && 1 === u && (I && -1 === y.indexOf("Dx=0, Dy=0") || D.test(e) && 100 !== parseFloat(RegExp.$1) || -1 === e.indexOf("gradient(") && m.removeAttribute("filter"))
            }
        }
          , St = function() {
            var t, e, a, i, s, o, r, n, h, l, u, m, c, g, p, f, _, I, v, D, y, b, w, x, S, A, T, P = this.data, E = this.t.style, M = P.rotation, k = P.scaleX, H = P.scaleY, L = P.scaleZ;
            if (d && (S = E.top ? "top" : E.bottom || parseFloat(z(this.t, "top", null, !1)) ? "bottom" : "top",
            y = z(this.t, S, null, !1),
            A = parseFloat(y) || 0,
            T = y.substr((A + "").length) || "px",
            P._ffFix = !P._ffFix,
            E[S] = (P._ffFix ? A + .05 : A - .05) + T),
            M || P.skewX)
                t = v = Math.cos(M),
                s = D = Math.sin(M),
                P.skewX && (M -= P.skewX,
                ...
                if (!P.rotationY && !P.rotationX && 1 === L)
                    return void (E[vt] = "translate3d(" + P.x + "px," + P.y + "px," + P.z + "px)" + (1 !== k || 1 !== H ? " scale(" + k + "," + H + ")" : ""));
                t = o = 1,
                e = s = 0
            }
            u = 1,
            a = i = r = n = h = l = m = c = g = 0,
            p = (f = P.perspective) ? -1 / f : 0,
            _ = P.zOrigin,
            I = 1e5,
            (M = P.rotationY) && (v = Math.cos(M),
            h = u * -(D = Math.sin(M)),
            c = p * -D,
            a = t * D,
            r = s * D,
            ...
            t *= v,
            s *= v),
            (M = P.rotationX) && (y = e * (v = Math.cos(M)) + a * (D = Math.sin(M)),
            b = o * v + r * D,
            w = l * v + u * D,
            x = g * v + p * D,
            a = e * -D + a * v,
            ...
            n = r * m,
            m = u * m + _),
            i = (y = (i += P.x) - (i |= 0)) ? (0 | y * I + (0 > y ? -.5 : .5)) / I + i : i,
            n = (y = (n += P.y) - (n |= 0)) ? (0 | y * I + (0 > y ? -.5 : .5)) / I + n : n,
            m = (y = (m += P.z) - (m |= 0)) ? (0 | y * I + (0 > y ? -.5 : .5)) / I + m : m,
            E[vt] = "matrix3d(" + [(0 | t * I) / I, (0 | s * I) / I, (0 | h * I) / I, (0 | c * I) / I, (0 | e * I) / I, (0 | o * I) / I, (0 | l * I) / I, (0 | g * I) / I, (0 | a * I) / I, (0 | r * I) / I, (0 | u * I) / I, (0 | p * I) / I, i, n, m, f ? 1 + -m / f : 1].join(",") + ")"
        }
          , At = function() {
            var t, e, a, i, s, o, r, n, h, l = this.data, u = this.t, m = u.style;
            d && (t = m.top ? "top" : m.bottom || parseFloat(z(u, "top", null, !1)) ? "bottom" : "top",
            e = z(u, t, null, !1),
            a = parseFloat(e) || 0,
            i = e.substr((a + "").length) || "px",
            l._ffFix = !l._ffFix,
            m[t] = (l._ffFix ? a + .05 : a - .05) + i),
            l.rotation || l.skewX ? (o = (s = l.rotation) - l.skewX,
            r = 1e5,
            n = l.scaleX * r,
            h = l.scaleY * r,
            m[vt] = "matrix(" + (0 | Math.cos(s) * n) / r + "," + (0 | Math.sin(s) * n) / r + "," + (0 | Math.sin(o) * -h) / r + "," + (0 | Math.cos(o) * h) / r + "," + l.x + "," + l.y + ")") : m[vt] = "matrix(" + l.scaleX + ",0,0," + l.scaleY + "," + l.x + "," + l.y + ")"
        };
        ft("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D", {
            parser: function(t, e, a, i, o, r, n) {
                if (i._transform)
                    return o;
                var h, l, u, m, d, c, g, p = i._transform = wt(t, s, !0, n.parseTransform), f = t.style, _ = 1e-6, I = It.length, v = n, D = {};
                if ("string" == typeof v.transform && vt)
                    u = f.cssText,
                    f[vt] = v.transform,
                    f.display = "block",
                    h = wt(t, null, !1),
                    ...
                    null != (g = v.directionalRotation))
                        if ("object" == typeof g)
                            ...
                            v.rotation = g;
                    h.rotation = st("rotation"in v ? v.rotation : "shortRotation"in v ? v.shortRotation + "_short" : "rotationZ"in v ? v.rotationZ : p.rotation * L, p.rotation, "rotation", D),
                    bt && (h.rotationX = st("rotationX"in v ? v.rotationX : "shortRotationX"in v ? v.shortRotationX + "_short" : p.rotationX * L || 0, p.rotationX, "rotationX", D),
                    h.rotationY = st("rotationY"in v ? v.rotationY : "shortRotationY"in v ? v.shortRotationY + "_short" : p.rotationY * L || 0, p.rotationY, "rotationY", D)),
                    h.skewX = null == v.skewX ? p.skewX : st(v.skewX, p.skewX),
                    h.skewY = null == v.skewY ? p.skewY : st(v.skewY, p.skewY),
                    (l = h.skewY - p.skewY) && (h.skewX += l,
                    h.rotation += l)
                }
                for (null != v.force3D && (p.force3D = v.force3D,
                c = !0),
                (d = p.force3D || p.z || p.rotationX || p.rotationY || h.z || h.rotationX || h.rotationY || h.perspective) || null == v.scale || (h.scaleZ = 1); --I > -1; )
                    ((m = h[a = It[I]] - p[a]) > _ || -_ > m || null != B[a]) && (c = !0,
                    o = new dt(p,a,p[a],m,o),
                    a in D && (o.e = D[a]),
                    o.xs0 = 0,
                    o.plugin = r,
                    i._overwriteProps.push(o.n));
                return ((m = v.transformOrigin) || bt && d && p.zOrigin) && (vt ? (c = !0,
                a = yt,
                m = (m || z(t, a, s, !1, "50% 50%")) + "",
                (o = new dt(f,a,0,0,o,-1,"transformOrigin")).b = f[a],
                o.plugin = r,
                bt ? (u = p.zOrigin,
                m = m.split(" "),
                p.zOrigin = (m.length > 2 && (0 === u || "0px" !== m[2]) ? parseFloat(m[2]) : u) || 0,
                o.xs0 = o.e = f[a] = m[0] + " " + (m[1] || "50%") + " 0px",
                (o = new dt(p,"zOrigin",0,0,o,-1,o.n)).b = u,
                o.xs0 = o.e = p.zOrigin) : o.xs0 = o.e = f[a] = m) : et(m + "", p)),
                c && (i._transformType = d || 3 === this._transformType ? 3 : 2),
                o
            },
            prefix: !0
        }),
        ...
        ft("borderRadius", {
            ...
            parser: function(t, e, a, o, r) {
                e = this.format(e);
                var n, h, l, u, m, d, c, g, p, f, _, I, v, D, y, b, w = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"], x = t.style;
                for (p = parseFloat(t.offsetWidth),
                f = parseFloat(t.offsetHeight),
                n = e.split(" "),
                h = 0; w.length > h; h++)
                    this.p.indexOf("border") && (w[h] = V(w[h])),
                    -1 !== (m = u = z(t, w[h], s, !1, "0px")).indexOf(" ") && (u = m.split(" "),
                    m = u[0],
                    u = u[1]),
                    d = l = n[h],
                    c = parseFloat(m),
                    I = m.substr((c + "").length),
                    (v = "=" === d.charAt(1)) ? (g = parseInt(d.charAt(0) + "1", 10),
                    d = d.substr(2),
                    g *= parseFloat(d),
                    _ = d.substr((g + "").length - (0 > g ? 1 : 0)) || "") : (g = parseFloat(d),
                    _ = d.substr((g + "").length)),
                    "" === _ && (_ = i[a] || I),
                    _ !== I && (D = j(t, "borderLeft", c, I),
                    y = j(t, "borderTop", c, I),
                    "%" === _ ? (m = D / p * 100 + "%",
                    u = y / f * 100 + "%") : "em" === _ ? (m = D / (b = j(t, "borderLeft", 1, "em")) + "em",
                    u = y / b + "em") : (m = D + "px",
                    u = y + "px"),
                    v && (d = parseFloat(m) + g + _,
                    l = parseFloat(u) + g + _)),
                    r = ct(x, w[h], m + " " + u, d + " " + l, !1, "0px", r);
                return r
            },
            prefix: !0,
        ...
        ft("backgroundPosition", {
            ...
            parser: function(t, e, a, i, o, r) {
                var n, h, l, u, m, d, c = "background-position", p = s || q(t, null), f = this.format((p ? g ? p.getPropertyValue(c + "-x") + " " + p.getPropertyValue(c + "-y") : p.getPropertyValue(c) : t.currentStyle.backgroundPositionX + " " + t.currentStyle.backgroundPositionY) || "0 0"), _ = this.format(e);
                if (-1 !== f.indexOf("%") != (-1 !== _.indexOf("%")) && ((d = z(t, "backgroundImage").replace(A, "")) && "none" !== d)) {
                    for (n = f.split(" "),
                    h = _.split(" "),
                    F.setAttribute("src", d),
                    l = 2; --l > -1; )
                        (u = -1 !== (f = n[l]).indexOf("%")) !== (-1 !== h[l].indexOf("%")) && (m = 0 === l ? t.offsetWidth - F.width : t.offsetHeight - F.height,
                        n[l] = u ? parseFloat(f) / 100 * m + "px" : parseFloat(f) / m * 100 + "%");
                    f = n.join(" ")
                }
        ...
        ft("clip", {
            ...
            parser: function(t, e, a, i, o, r) {
                ...
                l = 8 > g ? " " : ",",
                n = "rect(" + h.clipTop + l + h.clipRight + l + h.clipBottom + l + h.clipLeft + ")",
                e = this.format(e).split(",").join(l)) : (n = this.format(z(t, this.p, s, !1, this.dflt)),
                e = this.format(e)),
                this.parseComplex(t.style, n, e, o, r)
            }
        }),
        ft("textShadow", {
        ...
        var Tt = function(t) {
            var e, a = this.t, i = a.filter || z(this.data, "filter"), s = 0 | this.s + this.c * t;
            100 === s && (-1 === i.indexOf("atrix(") && -1 === i.indexOf("radient(") ? (a.removeAttribute("filter"),
            e = !z(this.data, "filter")) : (a.filter = i.replace(b, ""),
            e = !0)),
            e || (this.xn1 && (a.filter = i = i || "alpha(opacity=" + s + ")"),
            -1 === i.indexOf("opacity") ? 0 === s && this.xn1 || (a.filter += " alpha(opacity=" + s + ")") : a.filter = i.replace(D, "opacity=" + s))
        };
        ft("opacity,alpha,autoAlpha", {
            ...
            parser: function(t, e, a, i, o, r) {
                ...
                l && 1 === n && "hidden" === z(t, "visibility", s) && 0 !== e && (n = 0),
                R ? o = new dt(h,"opacity",n,e - n,o) : ((o = new dt(h,"opacity",100 * n,100 * (e - n),o)).xn1 = l ? 1 : 0,
                h.zoom = 1,
                o.type = 2,
                ...
                o.plugin = r,
                o.setRatio = Tt),
                l && ((o = new dt(h,"visibility",0,0,o,-1,null,!1,0,0 !== n ? "inherit" : "hidden",0 === e ? "hidden" : "inherit")).xs0 = "inherit",
                i._overwriteProps.push(o.n)),
                o
            }
        });
        var Pt = function(t, e) {
          ...
          , Et = function(t) {
            ...
            1 === t || 0 === t) {
                ...
                for (var e = this.data, a = this.t.style; e; )
                    e.v ? a[e.p] = e.v : Pt(a, e.p),
                    e = e._next;
        ...
        ft("className", {
            parser: function(t, e, i, o, r, n, h) {
                var l, u, m, d, c, g = t.className, p = t.style.cssText;
                if ((r = o._classNamePT = new dt(t,i,0,0,r,2)).setRatio = Et,
                r.pr = -11,
                a = !0,
                r.b = g,
                u = Q(t, s),
                ...
                r.e = "=" !== e.charAt(1) ? e : g.replace(RegExp("\\s*\\b" + e.substr(2) + "\\b"), "") + ("+" === e.charAt(0) ? " " + e.substr(2) : ""),
                o._tween._duration && (t.className = r.e,
                l = Z(t, u, Q(t), h, d),
                t.className = g,
                r.data = l.firstMPT,
                t.style.cssText = p,
                r = r.xfirst = o.parse(t, l.difs, r, n)),
                r
            }
        });
        var Mt = function(t) {
            if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration) {
                ...
                for (var e, a = this.t.style, i = this.e.split(","), s = i.length, o = n.transform.parse; --s > -1; )
                    e = i[s],
                    n[e] && (e = n[e].parse === o ? vt : n[e].p),
                    Pt(a, e)
            }
        };
        for (ft("clearProps", {
            parser: function(t, e, i, s, o) {
                return (o = new dt(t,i,0,0,o,2)).setRatio = Mt,
                o.e = e,
                o.pr = -10,
                o.data = s._tween,
                a = !0,
        ...
        h._onInitTween = function(t, e, n) {
            ...
            l = e.autoRound,
            a = !1,
            i = e.suffixMap || r.suffixMap,
            s = q(t, ""),
            o = this._overwriteProps;
            var h, d, g, p, f, _, I, v, D, b = t.style;
            if (u && "" === b.zIndex && (("auto" === (h = z(t, "zIndex", s)) || "" === h) && (b.zIndex = 0)),
            "string" == typeof e && (p = b.cssText,
            h = Q(t, s),
            b.cssText = p + ";" + e,
            h = Z(t, h, Q(t)).difs,
            !R && y.test(e) && (h.opacity = parseFloat(RegExp.$1)),
            e = h,
            b.cssText = p),
            ...
            this._transformType) {
                ...
                vt ? m && (u = !0,
                "" === b.zIndex && (("auto" === (I = z(t, "zIndex", s)) || "" === I) && (b.zIndex = 0)),
                c && (b.WebkitBackfaceVisibility = this._vars.WebkitBackfaceVisibility || (D ? "visible" : "hidden"))) : b.zoom = 1,
                g = d; g && g._next; )
                    g = g._next;
                v = new dt(t,"transform",0,0,null,2),
                this._linkCSSP(v, null, g),
                v.setRatio = D && bt ? St : vt ? At : xt,
                v.data = this._transform || wt(t, s, !0),
                o.pop()
            }
            if (a) {
                for (; d; ) {
                    ...
                    g = p; g && g.pr > d.pr; )
                        g = g._next;
                    (d._prev = g ? g._prev : f) ? d._prev._next = d : p = d,
                    (d._next = g) ? g._prev = d : f = d,
                    d = _
                }
                this._firstPT = p
            }
        ...
        h.parse = function(t, e, a, o) {
            ...
            for (r in e)
                c = e[r],
                (h = n[r]) ? a = h.parse(t, c, r, this, a, o, e) : (d = z(t, r, s) + "",
                f = "string" == typeof c,
                "color" === r || "fill" === r || "stroke" === r || -1 !== r.indexOf("Color") || f && w.test(c) ? (f || (c = ((c = nt(c)).length > 3 ? "rgba(" : "rgb(") + c.join(",") + ")"),
                a = ct(I, r, d, c, !0, "transparent", a, 0, o)) : !f || -1 === c.indexOf(" ") && -1 === c.indexOf(",") ? (g = (u = parseFloat(d)) || 0 === u ? d.substr((u + "").length) : "",
                ("" === d || "auto" === d) && ("width" === r || "height" === r ? (u = tt(t, r, s),
                g = "px") : "left" === r || "top" === r ? (u = K(t, r, s),
                g = "px") : (u = "opacity" !== r ? 0 : 1,
                g = "")),
                (_ = f && "=" === c.charAt(1)) ? (m = parseInt(c.charAt(0) + "1", 10),
                c = c.substr(2),
                m *= parseFloat(c),
                p = c.replace(v, "")) : (m = parseFloat(c),
                p = f && c.substr((m + "").length) || ""),
                "" === p && (p = i[r] || g),
                c = m || 0 === m ? (_ ? m + u : m) + p : e[r],
                g !== p && "" !== p && (m || 0 === m) && (u || 0 === u) && (u = j(t, r, u, g),
                "%" === p ? ((u /= j(t, r, 100, "%") / 100) > 100 && (u = 100),
                !0 !== e.strictUnits && (d = u + "%")) : "em" === p ? u /= j(t, r, 1, "em") : (m = j(t, r, m, p),
                p = "px"),
                _ && (m || 0 === m) && (c = m + u + p)),
                _ && (m += u),
                !u && 0 !== u || !m && 0 !== m ? void 0 !== I[r] && (c || "NaN" != c + "" && null != c) ? (a = new dt(I,r,m || u || 0,0,a,-1,r,!1,0,d,c)).xs0 = "none" !== c || "display" !== r && -1 === r.indexOf("Style") ? c : d : U("invalid " + r + " tween value: " + e[r]) : (a = new dt(I,r,u,m - u,a,0,r,!1 !== l && ("px" === p || "zIndex" === r),0,d,c)).xs0 = p) : a = ct(I, r, d, c, !0, null, a, 0, o)),
                o && a && !a.plugin && (a.plugin = o);
            return a
        }
        ,
        h.setRatio = function(t) {
            var e, a, i, s = this._firstPT, o = 1e-6;
            if (1 !== t || this._tween._time !== this._tween._duration && 0 !== this._tween._time)
                if (t || this._tween._time !== this._tween._duration && 0 !== this._tween._time || -1e-6 === this._tween._rawPrevTime)
                    for (; s; ) {
                        if (e = s.c * t + s.s,
                        s.r ? e = e > 0 ? 0 | e + .5 : 0 | e - .5 : o > e && e > -o && (e = 0),
                        s.type)
                            if (1 === s.type)
                                if (2 === (i = s.l))
        ...
        h._enableTransforms = function(t) {
            ...
            this._transform = this._transform || wt(this._target, s, !0)
        }
        ,
        h._linkCSSP = function(t, e, a, i) {
            ...
            i = !0),
            a ? a._next = t : i || null !== this._firstPT || (this._firstPT = t),
            t._next = e,
            t._prev = a),
            t
        }
        ...
        h._kill = function(e) {
            ...
            return e.className && (a = this._classNamePT) && ((s = a.xfirst) && s._prev ? this._linkCSSP(s._prev, a._next, s._prev._prev) : s === this._firstPT && (this._firstPT = a._next),
            a._next && this._linkCSSP(a._next, a._next._next, s._prev),
        ...
        var kt = function(t, e, a) {
            ...
            if (t.slice)
                ...
                for (s = (i = t.childNodes).length; --s > -1; )
                    ...
                    o.style && (e.push(Q(o)),
                    a && a.push(o)),
                    1 !== r && 9 !== r && 11 !== r || !o.childNodes.length || kt(o, e, a)
        };
        return r.cascadeTo = function(t, a, i) {
            var s, o, r, n = e.to(t, a, i), h = [n], l = [], u = [], m = [], d = e._internals.reservedProps;
            for (t = n._targets || n.target,
            kt(t, l, m),
            n.render(a, !0),
            kt(t, u),
            n.render(0, !0),
    ...
    function() {
        var t = window._gsDefine.plugin({
            ...
            API: 2,
            init: function(t, e, a) {
                return this._tween = a,
                !0
            }
        })
          , e = t.prototype;
        e._onInitAllProps = function() {
            for (var t, e, a, i = this._tween, s = i.vars.roundProps instanceof Array ? i.vars.roundProps : i.vars.roundProps.split(","), o = s.length, r = {}, n = i._propLookup.roundProps; --o > -1; )
                r[s[o]] = 1;
            for (o = s.length; --o > -1; )
                for (t = s[o],
                e = i._firstPT; e; )
                    a = e._next,
                    e.pg ? e.t._roundProps(r, !0) : e.n === t && (this._add(e.t, t, e.s, e.c),
                    a && (a._prev = e._prev),
                    e._prev ? e._prev._next = a : i._firstPT === e && (i._firstPT = a),
    ...
    window._gsDefine.plugin({
        ...
        init: function(t, e) {
            ...
            if ("function" != typeof t.setAttribute)
                return !1;
            for (a in this._target = t,
            this._proxy = {},
            e)
                this._addTween(this._proxy, a, parseFloat(t.getAttribute(a)), e[a], a) && this._overwriteProps.push(a);
            return !0
        },
        set: function(t) {
            this._super.setRatio.call(this, t);
            for (var e, a = this._overwriteProps, i = a.length; --i > -1; )
                e = a[i],
    ...
    window._gsDefine.plugin({
        ...
        init: function(t, e) {
            ...
            this.finals = {};
            var a, i, s, o, r, n = !0 === e.useRadians ? 2 * Math.PI : 360, h = 1e-6;
            for (a in e)
                "useRadians" !== a && (i = (r = (e[a] + "").split("_"))[0],
                s = parseFloat("function" != typeof t[a] ? t[a] : t[a.indexOf("set") || "function" != typeof t["get" + a.substr(3)] ? a : "get" + a.substr(3)]()),
                o = (this.finals[a] = "string" == typeof i && "=" === i.charAt(1) ? s + parseInt(i.charAt(0) + "1", 10) * Number(i.substr(2)) : Number(i) || 0) - s,
                r.length && (-1 !== (i = r.join("_")).indexOf("short") && ((o %= n) !== o % (n / 2) && (o = 0 > o ? o + n : o - n)),
                -1 !== i.indexOf("_cw") && 0 > o ? o = (o + 9999999999 * n) % n - (0 | o / n) * n : -1 !== i.indexOf("ccw") && o > 0 && (o = (o - 9999999999 * n) % n - (0 | o / n) * n)),
                (o > h || -h > o) && (this._addTween(t, a, s, s + o, a),
    ...
    window._gsDefine("easing.Back", ["easing.Ease"], (function(t) {
        var e, a, i, s = window.GreenSockGlobals || window, o = s.com.greensock, r = 2 * Math.PI, n = Math.PI / 2, h = o._class, l = function(e, a) {
        ...
        ,
        p.ease = new p(.7,.7),
        f.config = p.config = function(t, e, a) {
            return new p(t,e,a)
        }
        ,
        ...
        (f = e.prototype = new t).constructor = e,
        f.getRatio = function(t) {
        ...
        a = h("easing.RoughEase", (function(e) {
            for (var a, i, s, o, r, n, h = (e = e || {}).taper || "none", l = [], u = 0, m = 0 | (e.points || 20), c = m, g = !1 !== e.randomize, p = !0 === e.clamp, f = e.template instanceof t ? e.template : null, _ = "number" == typeof e.strength ? .4 * e.strength : .4; --c > -1; )
                a = g ? Math.random() : 1 / m * c,
                i = f ? f.getRatio(a) : a,
                "none" === h ? s = _ : "out" === h ? s = (o = 1 - a) * o * _ : "in" === h ? s = a * a * _ : .5 > a ? s = .5 * (o = 2 * a) * o * _ : s = .5 * (o = 2 * (1 - a)) * o * _,
                g ? i += Math.random() * s - .5 * s : c % 2 ? i += .5 * s : i -= .5 * s,
                p && (i > 1 ? i = 1 : 0 > i && (i = 0)),
                l[u++] = {
                    x: a,
                    y: i
        ...
        (f = a.prototype = new t).constructor = a,
        f.getRatio = function(t) {
            var e = this._prev;
            if (t > e.t) {
                for (; e.next && t >= e.t; )
        ...
        ,
        a.ease = new a,
        m("Bounce", l("BounceOut", (function(t) {
...
function(t) {
    "use strict";
    var e, a, i, s, o, r = t.GreenSockGlobals || t, n = function(t) {
        var e, a = t.split("."), i = r;
        for (e = 0; a.length > e; e++)
            i[a[e]] = i = i[a[e]] || {};
        return i
    }, h = n("com.greensock"), l = [].slice, u = function() {}, m = {}, d = function(e, a, i, s) {
        this.sc = m[e] ? m[e].sc : [],
        m[e] = this,
        this.gsClass = null,
        this.func = i;
        ...
        this.check = function(h) {
            for (var l, u, c, g, p = a.length, f = p; --p > -1; )
                (l = m[a[p]] || new d(a[p],[])).gsClass ? (o[p] = l.gsClass,
                f--) : h && l.sc.push(this);
            if (0 === f && i)
                for (c = (u = ("com.greensock." + e).split(".")).pop(),
                g = n(u.join("."))[c] = this.gsClass = i.apply(i, o),
                s && (r[c] = g,
    ...
    var p = [0, 0, 1, 1]
      ...
      , v = _.register = function(t, e, a, i) {
        for (var s, o, r, n, l = e.split(","), u = l.length, m = (a || "easeIn,easeOut,easeInOut").split(","); --u > -1; )
            for (o = l[u],
            s = i ? g("easing." + o, null, !0) : h.easing[o] || {},
            r = m.length; --r > -1; )
                n = m[r],
                I[o + "." + n] = I[n + o] = s[n] = t.getRatio ? t : t[n] || new t
    }
    ;
    for ((i = _.prototype)._calcEnd = !1,
    i.getRatio = function(t) {
        ...
        return 1 === a ? i *= i : 2 === a ? i *= i * i : 3 === a ? i *= i * i * i : 4 === a && (i *= i * i * i * i),
        1 === e ? 1 - i : 2 === e ? i : .5 > t ? i / 2 : 1 - i / 2
    }
    ,
    a = (e = ["Linear", "Quad", "Cubic", "Quart", "Quint,Strong"]).length; --a > -1; )
        i = e[a] + ",Power" + a,
        v(new _(null,null,1,a), i, "easeOut", !0),
        v(new _(null,null,2,a), i, "easeIn" + (0 === a ? ",easeNone" : "")),
        v(new _(null,null,3,a), i, "easeInOut");
    I.linear = h.easing.Linear.easeIn,
    I.swing = h.easing.Quad.easeInOut;
    ...
    (i = D.prototype).addEventListener = function(t, e, a, i, r) {
        r = r || 0;
        var n, h, l = this._listeners[t], u = 0;
        for (null == l && (this._listeners[t] = l = []),
        h = l.length; --h > -1; )
            (n = l[h]).c === e && n.s === a ? l.splice(h, 1) : 0 === u && r > n.pr && (u = h + 1);
        l.splice(u, 0, {
            c: e,
            s: a,
            up: i,
    ...
    i.dispatchEvent = function(t) {
        ...
        if (s)
            for (e = s.length,
            a = this._eventTarget; --e > -1; )
                (i = s[e]).up ? i.c.call(i.s || a, {
                    type: t,
                    target: a
                }) : i.c.call(i.s || a)
    }
    ...
    var y = t.requestAnimationFrame
      ...
      , x = w();
    for (a = (e = ["ms", "moz", "webkit", "o"]).length; --a > -1 && !y; )
        y = t[e[a] + "RequestAnimationFrame"],
        b = t[e[a] + "CancelAnimationFrame"] || t[e[a] + "CancelRequestAnimationFrame"];
    g("Ticker", (function(t, e) {
        var a, i, r, n, h, l = this, m = w(), d = !1 !== e && y, c = function(t) {
            x = w(),
            l.time = (x - m) / 1e3;
            var e, s = l.time - h;
            (!a || s > 0 || !0 === t) && (l.frame++,
        ...
        ,
        this.fps = function(t) {
            return arguments.length ? (n = 1 / ((a = t) || 60),
            h = this.time + n,
            void l.wake()) : a
        }
        ,
    ...
    s = S.ticker = new h.Ticker,
    (i = S.prototype)._dirty = i._gc = i._initted = i._paused = !1,
    ...
    i._swapSelfInParams = function(t) {
        for (var e = t.length, a = t.concat(); --e > -1; )
            "{self}" === t[e] && (a[e] = this);
        return a
    }
    ,
    i.eventCallback = function(t, e, a, i) {
        if ("on" === (t || "").substr(0, 2)) {
            ...
            s[t + "Params"] = a instanceof Array && -1 !== a.join("").indexOf("{self}") ? this._swapSelfInParams(a) : a,
            s[t + "Scope"] = i),
    ...
    i.paused = function(t) {
        ...
        if (t != this._paused && this._timeline) {
            ...
            this._uncache(!1)),
            this._pauseTime = t ? a : null,
            this._paused = t,
            this._active = !t && this._totalTime > 0 && this._totalTime < this._totalDuration,
            t || 0 === i || 0 === this._duration || this.render(e.smoothChildTiming ? this._totalTime : (a - this._startTime) / this._timeScale, !0, !0)
        }
    ...
    (i = T.prototype = new S).constructor = T,
    i.kill()._gc = !1,
    ...
    i.add = i.insert = function(t, e) {
        ...
        a = this._last,
        this._sortChildren)
            for (i = t._startTime; a && a._startTime > i; )
                a = a._prev;
    ...
    i.render = function(t, e, a) {
        ...
        for (this._totalTime = this._time = this._rawPrevTime = t; s; )
            i = s._next,
            (s._active || t >= s._startTime && !s._paused) && (s._reversed ? s.render((s._dirty ? s.totalDuration() : s._totalDuration) - (t - s._startTime) * s._timeScale, e, a) : s.render((t - s._startTime) * s._timeScale, e, a)),
            s = i
    }
    ,
    i.rawTime = function() {
    ...
    var P = g("TweenLite", (function(e, a, i) {
        ...
        var s, o, r, n = e.jquery || e.length && e !== t && e[0] && (e[0] === t || e[0].nodeType && e[0].style && !e.nodeType), h = this.vars.overwrite;
        if (this._overwrite = h = null == h ? C[P.defaultOverwrite] : "number" == typeof h ? h >> 0 : C[h],
        (n || e instanceof Array) && "number" != typeof e[0])
            for (this._targets = r = l.call(e, 0),
            this._propLookup = [],
            this._siblings = [],
            s = 0; r.length > s; s++)
                (o = r[s]) ? "string" != typeof o ? o.length && o !== t && o[0] && (o[0] === t || o[0].nodeType && o[0].style && !o.nodeType) ? (r.splice(s--, 1),
                this._targets = r = r.concat(l.call(o, 0))) : (this._siblings[s] = N(o, this, !1),
                1 === h && this._siblings[s].length > 1 && Y(o, this, null, 1, this._siblings[s])) : "string" == typeof (o = r[s--] = P.selector(o)) && r.splice(s + 1, 1) : r.splice(s--, 1);
        else
            this._propLookup = {},
            this._siblings = N(e, this, !1),
    ...
    (i = P.prototype = new S).constructor = P,
    i.kill()._gc = !1,
    i.ratio = 0,
    i._firstPT = i._targets = i._overwrittenProps = i._startAt = null,
    i._notifyPluginsOfEnabled = !1,
    P.version = "1.10.2",
    P.defaultEase = i._ease = new _(null,null,1,1),
    ...
    F._startTime = s.time,
    G._startTime = s.frame,
    F._active = G._active = !0,
    S._updateRoot = function() {
        if (F.render((s.time - F._startTime) * F._timeScale, !1, !1),
        G.render((s.frame - G._startTime) * G._timeScale, !1, !1),
        !(s.frame % 120)) {
            var t, e, a;
            for (a in H) {
                for (t = (e = H[a].tweens).length; --t > -1; )
    ...
    var N = function(t, e, a) {
      ...
      , Y = function(t, e, a, i, s) {
        ...
        if (1 === i || i >= 4) {
            ...
            o = 0; h > o; o++)
                if ((n = s[o]) !== e)
                    n._gc || n._enabled(!1, !1) && (r = !0);
                else if (5 === i)
                    break;
            return r
        }
        var l, u = e._startTime + 1e-10, m = [], d = 0, c = 0 === e._duration;
        for (o = s.length; --o > -1; )
            (n = s[o]) === e || n._gc || n._paused || (n._timeline !== e._timeline ? (l = l || R(e, 0, c),
            0 === R(n, l, c) && (m[d++] = n)) : u >= n._startTime && n._startTime + n.totalDuration() / n._timeScale + 1e-10 > u && ((c || !n._initted) && 2e-10 >= u - n._startTime || (m[d++] = n)));
        for (o = d; --o > -1; )
            n = m[o],
            2 === i && n._kill(a, t) && (r = !0),
            (2 !== i || !n._firstPT && n._initted) && n._enabled(!1, !1) && (r = !0);
        return r
    }
      , R = function(t, e, a) {
    ...
    i._init = function() {
        var t, e, a, i, s = this.vars, o = this._overwrittenProps, r = this._duration, n = s.immediateRender, h = s.ease;
        if (s.startAt) {
            if (this._startAt && this._startAt.render(-1, !0),
            s.startAt.overwrite = 0,
            s.startAt.immediateRender = !0,
            this._startAt = P.to(this.target, 0, s.startAt),
            n)
                if (this._time > 0)
                    this._startAt = null;
                else if (0 !== r)
            ...
            if (this._startAt)
                ...
                for (i in a = {},
                s)
                    B[i] && "autoCSS" !== i || (a[i] = s[i]);
                return a.overwrite = 0,
                void (this._startAt = P.to(this.target, 0, a))
            }
        if (this._ease = h ? h instanceof _ ? s.easeParams instanceof Array ? h.config.apply(h, s.easeParams) : h : "function" == typeof h ? new _(h,s.easeParams) : I[h] || P.defaultEase : P.defaultEase,
    ...
    i._initProps = function(e, a, i, s) {
        ...
        for (o in this.vars.css || e.style && e !== t && e.nodeType && k.css && !1 !== this.vars.autoCSS && function(t, e) {
            var a, i = {};
            for (a in t)
                B[a] || a in e && "x" !== a && "y" !== a && "width" !== a && "height" !== a && "className" !== a && "border" !== a || !(!k[a] || k[a] && k[a]._autoCSS) || (i[a] = t[a],
                delete t[a]);
            t.css = i
        }(this.vars, e),
        this.vars) {
            ...
            B[o])
                ...
                r = h._overwriteProps.length; --r > -1; )
                    a[h._overwriteProps[r]] = this._firstPT;
                (h._priority || h._onInitAllProps) && (n = !0),
        ...
        return s && this._kill(s, e) ? this._initProps(e, a, i, s) : this._overwrite > 1 && this._firstPT && i.length > 1 && Y(e, this, a, this._overwrite, i) ? (this._kill(a, e),
        this._initProps(e, a, i, s)) : n
    }
    ,
    i.render = function(t, e, a) {
        ...
        if (t >= this._duration)
            ...
            this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0,
            (0 !== r || 0 === this._duration && this._rawPrevTime > 0) && (s = "onReverseComplete",
            i = this._reversed),
            0 > t ? (this._active = !1,
            0 === this._duration && (this._rawPrevTime >= 0 && (a = !0),
            this._rawPrevTime = t)) : this._initted || (a = !0);
        ...
        this._easeType) {
            ...
            (1 === h || 3 === h && n >= .5) && (n = 1 - n),
            3 === h && (n *= 2),
            1 === l ? n *= n : 2 === l ? n *= n * n : 3 === l ? n *= n * n * n : 4 === l && (n *= n * n * n * n),
            this.ratio = 1 === h ? 1 - n : 2 === h ? n : .5 > t / this._duration ? n / 2 : 1 - n / 2
        } else
        ...
        if (this._time !== r || a) {
            ...
            for (this._active || !this._paused && this._time !== r && t >= 0 && (this._active = !0),
            0 === r && (this._startAt && (t >= 0 ? this._startAt.render(t, e, a) : s || (s = "_dummyGS")),
            this.vars.onStart && (0 !== this._time || 0 === this._duration) && (e || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || f))),
            o = this._firstPT; o; )
                o.f ? o.t[o.p](o.c * this.ratio + o.s) : o.t[o.p] = o.c * this.ratio + o.s,
                o = o._next;
            this._onUpdate && (0 > t && this._startAt && this._startAt.render(t, e, a),
            e || this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || f)),
            s && (this._gc || (0 > t && this._startAt && !this._onUpdate && this._startAt.render(t, e, a),
            i && (this._timeline.autoRemoveChildren && this._enabled(!1, !1),
            this._active = !1),
            !e && this.vars[s] && this.vars[s].apply(this.vars[s + "Scope"] || this, this.vars[s + "Params"] || f)))
        }
    }
    ,
    i._kill = function(t, e) {
        ...
        if (((e = "string" != typeof e ? e || this._targets || this.target : P.selector(e) || e)instanceof Array || E(e)) && "number" != typeof e[0])
            for (a = e.length; --a > -1; )
                this._kill(t, e[a]) && (n = !0);
        else {
            if (this._targets) {
                for (a = this._targets.length; --a > -1; )
                    if (e === this._targets[a]) {
                        r = this._propLookup[a] || {},
                        this._overwrittenProps = this._overwrittenProps || [],
                        i = this._overwrittenProps[a] = t ? this._overwrittenProps[a] || {} : "all";
                        break
                    }
            } else {
                if (e !== this.target)
            ...
            if (r) {
                for (s in h = t || r,
                l = t !== i && "all" !== i && t !== r && (null == t || !0 !== t._tempKill),
                h)
                    (o = r[s]) && (o.pg && o.t._kill(h) && (n = !0),
    ...
    P.killTweensOf = P.killDelayedCallsTo = function(t, e) {
        for (var a = P.getTweensOf(t), i = a.length; --i > -1; )
            a[i]._kill(e, t)
    }
    ,
    P.getTweensOf = function(t) {
        ...
        if (((t = "string" != typeof t ? t : P.selector(t) || t)instanceof Array || E(t)) && "number" != typeof t[0]) {
            for (e = t.length,
            a = []; --e > -1; )
                a = a.concat(P.getTweensOf(t[e]));
            for (e = a.length; --e > -1; )
                for (s = a[e],
                i = e; --i > -1; )
                    s === a[i] && a.splice(e, 1)
        } else
            for (e = (a = N(t).concat()).length; --e > -1; )
                a[e]._gc && a.splice(e, 1);
        return a
    }
    ;
    ...
    O.API = 2,
    i._firstPT = null,
    i._addTween = function(t, e, a, i, s, o) {
        var r, n;
        ...
        n._next && (n._next._prev = n),
        n) : void 0
    }
    ,
    i.setRatio = function(t) {
        for (var e, a = this._firstPT, i = 1e-6; a; )
            e = a.c * t + a.s,
            a.r ? e = 0 | e + (e > 0 ? .5 : -.5) : i > e && e > -i && (e = 0),
            a.f ? a.t[a.p](e) : a.t[a.p] = e,
            a = a._next
    }
    ,
    i._kill = function(t) {
        var e, a = this._overwriteProps, i = this._firstPT;
        if (null != t[this._propName])
            this._overwriteProps = [];
        else
            for (e = a.length; --e > -1; )
                null != t[a[e]] && a.splice(e, 1);
        for (; i; )
    ...
    i._roundProps = function(t, e) {
        for (var a = this._firstPT; a; )
            (t[this._propName] || null != a.n && t[a.n.split(this._propName + "_").join("")]) && (a.r = e),
            a = a._next
    }
    ,
    P._onPluginEvent = function(t, e) {
        ...
        for (; n; )
            n.pg && "function" == typeof n.t[t] && n.t[t]() && (a = !0),
            n = n._next;
        return a
    }
    ,
    O.activate = function(t) {
        for (var e = t.length; --e > -1; )
            t[e].API === O.API && (k[(new t[e])._propName] = t[e]);
        return !0
    }
    ,
    c.plugin = function(t) {
        ...
        var e, a = t.propName, i = t.priority || 0, s = t.overwriteProps, o = {
            init: "_onInitTween",
            set: "setRatio",
            kill: "_kill",
            round: "_roundProps",
        ...
        ), !0 === t.global), n = r.prototype = new O(a);
        for (e in n.constructor = r,
        r.API = t.API,
        o)
            "function" == typeof t[e] && (n[o[e]] = t[e]);
    ...
    e = t._gsQueue) {
        for (a = 0; e.length > a; a++)
            e[a]();
        for (i in m)
            m[i].func || t.console.log("GSAP encountered missing dependency: com.greensock." + i)
    }
    o = !1
}(window),
function() {
    ...
    t.prototype = {
        ...
        mute: function(t) {
            ...
            a.ctx || l(),
            a._muted = t,
            a.usingWebAudio && (a.masterGain.gain.value = t ? 0 : a._volume);
            for (var i = 0; i < a._howls.length; i++)
                if (!a._howls[i]._webAudio)
                    for (var s = a._howls[i]._getSoundIds(), o = 0; o < s.length; o++) {
                        var r = a._howls[i]._soundById(s[o]);
        ...
        unload: function() {
            for (var t = this || e, a = t._howls.length - 1; a >= 0; a--)
                t._howls[a].unload();
        ...
        _enableMobileAudio: function() {
            ...
            if (!t._mobileEnabled && t.ctx && (a || i)) {
                ...
                return document.addEventListener("touchend", s, !0),
                t
            }
        },
                ...
                for (var a = 0; a < t._howls.length; a++)
                    if (t._howls[a]._webAudio)
                        for (var i = 0; i < t._howls[a]._sounds.length; i++)
                            if (!t._howls[a]._sounds[i]._paused)
                                return t;
    ...
    a.prototype = {
        init: function(t) {
            var a = this;
            return e.ctx || l(),
            a._autoplay = t.autoplay || !1,
            a._format = "string" != typeof t.format ? t.format : [t.format],
            a._html5 = t.html5 || !1,
            a._muted = t.mute || !1,
            a._loop = t.loop || !1,
            a._pool = t.pool || 5,
            a._preload = "boolean" != typeof t.preload || t.preload,
            a._rate = t.rate || 1,
            a._sprite = t.sprite || {},
            a._src = "string" != typeof t.src ? t.src : [t.src],
            a._volume = void 0 !== t.volume ? t.volume : 1,
            a._duration = 0,
            a._state = "unloaded",
            a._sounds = [],
            a._endTimers = {},
            ...
            a._onresume = [],
            a._webAudio = e.usingWebAudio && !a._html5,
        ...
        load: function() {
            ...
            if (!e.noAudio) {
                ...
                return a ? (t._src = a,
                t._state = "loading",
                "https:" === window.location.protocol && "http:" === a.slice(0, 5) && (t._html5 = !0,
                t._webAudio = !1),
                new i(t),
                t._webAudio && o(t),
        ...
        play: function(t, a) {
            ...
            if ("number" == typeof t)
                ...
                if (void 0 === t) {
                    t = "__default";
                    for (var o = 0, r = 0; r < i._sounds.length; r++)
                        i._sounds[r]._paused && !i._sounds[r]._ended && (o++,
                        s = i._sounds[r]._id);
                    1 === o ? t = null : s = null
                }
            }
            ...
            n._sprite = t,
            n._seek = l,
            n._start = i._sprite[t][0] / 1e3,
            n._stop = (i._sprite[t][0] + i._sprite[t][1]) / 1e3,
            n._loop = !(!n._loop && !i._sprite[t][2]);
            var d = n._node;
            if (i._webAudio) {
                var c = function() {
                    i._refreshBuffer(n);
                    ...
                    n._playStart = e.ctx.currentTime,
                    void 0 === d.bufferSource.start ? n._loop ? d.bufferSource.noteGrainOn(0, l, 86400) : d.bufferSource.noteGrainOn(0, l, u) : n._loop ? d.bufferSource.start(0, l, 86400) : d.bufferSource.start(0, l, u),
                    m !== 1 / 0 && (i._endTimers[n._id] = setTimeout(i._ended.bind(i, n), m)),
                  ...
                  , g = "running" === e.state;
                if ("loaded" === i._state && g)
                    c();
                else {
                    var p = g || "loaded" !== i._state ? "load" : "resume";
                    i.once(p, c, g ? n._id : null),
                    i._clearTimer(n._id)
                }
            } else {
                var f = function() {
                    d.currentTime = l,
                    d.muted = n._muted || i._muted || e._muted || d.muted,
                    d.volume = n._volume * e.volume(),
                    d.playbackRate = n._rate,
                    d.play(),
                    m !== 1 / 0 && (i._endTimers[n._id] = setTimeout(i._ended.bind(i, n), m)),
                    a || i._emit("play", n._id)
                }
                ...
                if (4 === d.readyState || _)
                    ...
                    var I = function() {
                        f(),
                        d.removeEventListener(e._canPlayEvent, I, !1)
                    };
                    d.addEventListener(e._canPlayEvent, I, !1),
                    i._clearTimer(n._id)
                }
            }
            return n._id
        ...
        pause: function(t) {
            ...
            for (var a = e._getSoundIds(t), i = 0; i < a.length; i++) {
                ...
                if (s && !s._paused && (s._seek = e.seek(a[i]),
                s._rateSeek = 0,
                s._paused = !0,
                e._stopFade(a[i]),
                s._node))
                    if (e._webAudio) {
                        if (!s._node.bufferSource)
                            continue;
                        void 0 === s._node.bufferSource.stop ? s._node.bufferSource.noteOff(0) : s._node.bufferSource.stop(0),
        ...
        stop: function(t, e) {
            ...
            for (var i = a._getSoundIds(t), s = 0; s < i.length; s++) {
                ...
                o._ended = !0,
                a._stopFade(i[s]),
                o._node && (a._webAudio ? o._node.bufferSource && (void 0 === o._node.bufferSource.stop ? o._node.bufferSource.noteOff(0) : o._node.bufferSource.stop(0),
                a._cleanBuffer(o._node)) : isNaN(o._node.duration) && o._node.duration !== 1 / 0 || (o._node.currentTime = o._start || 0,
                o._node.pause())),
                e || a._emit("stop", o._id))
            }
            return a
        },
        mute: function(t, a) {
            ...
            for (var s = i._getSoundIds(a), o = 0; o < s.length; o++) {
                ...
                r && (r._muted = t,
                i._webAudio && r._node ? r._node.gain.setValueAtTime(t ? 0 : r._volume, e.ctx.currentTime) : r._node && (r._node.muted = !!e._muted || t),
                i._emit("mute", r._id))
            }
            return i
        },
        volume: function() {
            var t, a, i, s = this, o = arguments;
            if (0 === o.length)
                return s._volume;
            if (1 === o.length || 2 === o.length && void 0 === o[1] ? s._getSoundIds().indexOf(o[0]) >= 0 ? a = parseInt(o[0], 10) : t = parseFloat(o[0]) : o.length >= 2 && (t = parseFloat(o[0]),
            a = parseInt(o[1], 10)),
            !(void 0 !== t && t >= 0 && t <= 1))
                return (i = a ? s._soundById(a) : s._sounds[0]) ? i._volume : 0;
            if ("loaded" !== s._state)
                ...
                s;
            void 0 === a && (s._volume = t),
            a = s._getSoundIds(a);
            for (var r = 0; r < a.length; r++)
                (i = s._soundById(a[r])) && (i._volume = t,
                o[2] || s._stopFade(a[r]),
                s._webAudio && i._node && !i._muted ? i._node.gain.setValueAtTime(t, e.ctx.currentTime) : i._node && !i._muted && (i._node.volume = t * e.volume()),
                s._emit("volume", i._id));
            return s
        },
        fade: function(t, a, i, s) {
            ...
            for (var u = o._getSoundIds(s), m = 0; m < u.length; m++) {
                ...
                if (d) {
                    if (s || o._stopFade(u[m]),
                    o._webAudio && !d._muted) {
                        var c = e.ctx.currentTime
                          , g = c + i / 1e3;
                        d._volume = t,
                        d._node.gain.setValueAtTime(t, c),
                        d._node.gain.linearRampToValueAtTime(a, g)
                    }
                    var p = t;
                    d._interval = setInterval(function(e, i) {
                        ...
                        o._webAudio ? (void 0 === s && (o._volume = p),
                        i._volume = p) : o.volume(p, e, !0),
                        (a < t && p <= a || a > t && p >= a) && (clearInterval(i._interval),
                        i._interval = null,
                        o.volume(a, e),
                        o._emit("fade", e))
                    }
        ...
        _stopFade: function(t) {
            var a = this
              , i = a._soundById(t);
            return i && i._interval && (a._webAudio && i._node.gain.cancelScheduledValues(e.ctx.currentTime),
        ...
        loop: function() {
            var t, e, a, i = this, s = arguments;
            if (0 === s.length)
                return i._loop;
            if (1 === s.length) {
                if ("boolean" != typeof s[0])
                    return !!(a = i._soundById(parseInt(s[0], 10))) && a._loop;
                t = s[0],
                i._loop = t
            } else
                2 === s.length && (t = s[0],
                e = parseInt(s[1], 10));
            for (var o = i._getSoundIds(e), r = 0; r < o.length; r++)
                (a = i._soundById(o[r])) && (a._loop = t,
                i._webAudio && a._node && a._node.bufferSource && (a._node.bufferSource.loop = t,
        ...
        rate: function() {
            ...
            if (0 === o.length)
                ...
                2 === o.length && (t = parseFloat(o[0]),
                a = parseInt(o[1], 10));
            if ("number" != typeof t)
                return (i = s._soundById(a)) ? i._rate : s._rate;
            if ("loaded" !== s._state)
                return s._queue.push({
                    event: "rate",
                    action: function() {
            ...
            for (var r = 0; r < a.length; r++)
                if (i = s._soundById(a[r])) {
                    i._rateSeek = s.seek(a[r]),
                    i._playStart = s._webAudio ? e.ctx.currentTime : i._playStart,
                    i._rate = t,
                    s._webAudio && i._node && i._node.bufferSource ? i._node.bufferSource.playbackRate.value = t : i._node && (i._node.playbackRate = t);
                    var n = s.seek(a[r])
                      , h = 1e3 * ((s._sprite[i._sprite][0] + s._sprite[i._sprite][1]) / 1e3 - n) / Math.abs(i._rate);
                    !s._endTimers[a[r]] && i._paused || (s._clearTimer(a[r]),
                    s._endTimers[a[r]] = setTimeout(s._ended.bind(s, i), h)),
                    s._emit("rate", i._id)
                }
            return s
        },
        seek: function() {
            ...
            if (0 === s.length)
                ...
                i._getSoundIds().indexOf(s[0]) >= 0 ? a = parseInt(s[0], 10) : (a = i._sounds[0]._id,
                t = parseFloat(s[0]))
            } else
                2 === s.length && (t = parseFloat(s[0]),
                a = parseInt(s[1], 10));
            if (void 0 === a)
                return i;
            if ("loaded" !== i._state)
        ...
        duration: function(t) {
            var e = this
              , a = e._duration
              , i = e._soundById(t);
            return i && (a = e._sprite[i._sprite][1] / 1e3),
            a
        },
        state: function() {
            return this._state
        ...
        unload: function() {
            for (var t = this, a = t._sounds, i = 0; i < a.length; i++) {
                a[i]._paused || t.stop(a[i]._id),
                t._webAudio || (/MSIE |Trident\//.test(e._navigator && e._navigator.userAgent) || (a[i]._node.src = "data:audio/wav;base64,UklGRigAAABXQVZFZm10IBIAAAABAAEARKwAAIhYAQACABAAAABkYXRhAgAAAAEA"),
                a[i]._node.removeEventListener("error", a[i]._errorFn, !1),
                a[i]._node.removeEventListener(e._canPlayEvent, a[i]._loadFn, !1)),
                delete a[i]._node,
                t._clearTimer(a[i]._id);
        ...
        off: function(t, e, a) {
            ...
            e || a)
                ...
                for (o = 0; o < n.length; o++)
                    0 === n[o].indexOf("_on") && Array.isArray(i[n[o]]) && (i[n[o]] = [])
            }
            return i
        },
        once: function(t, e, a) {
        ...
        _emit: function(t, e, a) {
            for (var i = this, s = i["_on" + t], o = s.length - 1; o >= 0; o--)
                s[o].id && s[o].id !== e && "load" !== t || (setTimeout(function(t) {
                    t.call(this, e, a)
                }
                .bind(i, s[o].fn), 0),
                s[o].once && i.off(t, s[o].fn, s[o].id));
            return i
        },
        _loadQueue: function() {
            var t = this;
        ...
        _ended: function(t) {
            var a = this
              , i = t._sprite;
            if (!a._webAudio && a._node && !a._node.ended)
                return setTimeout(a._ended.bind(a, t), 100),
                a;
            var s = !(!t._loop && !a._sprite[i][2]);
            if (a._emit("end", t._id),
            !a._webAudio && s && a.stop(t._id, !0).play(t._id),
            a._webAudio && s) {
                a._emit("play", t._id),
                t._seek = t._start || 0,
                t._rateSeek = 0,
            ...
            return a._webAudio && !s && (t._paused = !0,
            t._ended = !0,
            t._seek = t._start || 0,
            t._rateSeek = 0,
            a._clearTimer(t._id),
            a._cleanBuffer(t._node),
            e._autoSuspend()),
            a._webAudio || s || a.stop(t._id),
            a
        },
    ...
    i.prototype = {
        ...
        create: function() {
            ...
            return a._webAudio ? (t._node = void 0 === e.ctx.createGain ? e.ctx.createGainNode() : e.ctx.createGain(),
        ...
        _loadListener: function() {
            var t = this
              , a = t._parent;
            a._duration = Math.ceil(10 * t._node.duration) / 10,
    ...
    var s = {}
      , o = function(t) {
        var e = t._src;
        if (s[e])
            return t._duration = s[e].duration,
            void h(t);
        if (/^data:[^;]+;base64,/.test(e)) {
            for (var a = atob(e.split(",")[1]), i = new Uint8Array(a.length), o = 0; o < a.length; ++o)
                i[o] = a.charCodeAt(o);
            n(i.buffer, t)
        } else {
      ...
      , n = function(t, a) {
        e.ctx.decodeAudioData(t, (function(t) {
            t && a._sounds.length > 0 && (s[a._src] = t,
            h(a, t))
        }
        ), (function() {
      ...
      , l = function() {
        ...
        e.masterGain.gain.value = e._muted ? 0 : 1,
...
function() {
    ...
    HowlerGlobal.prototype.pos = function(t, e, a) {
        ...
        a = "number" != typeof a ? i._pos[2] : a,
        "number" != typeof t ? i._pos : (i._pos = [t, e, a],
    ...
    HowlerGlobal.prototype.orientation = function(t, e, a, i, s, o) {
        ...
        return e = "number" != typeof e ? n[1] : e,
        a = "number" != typeof a ? n[2] : a,
        i = "number" != typeof i ? n[3] : i,
        s = "number" != typeof s ? n[4] : s,
        o = "number" != typeof o ? n[5] : o,
        "number" != typeof t ? n : (r._orientation = [t, e, a, i, s, o],
        r.ctx.listener.setOrientation(t, e, a, i, s, o),
        r)
    }
    ,
    ...
    Howl.prototype.stereo = function(e, a) {
        ...
        for (var o = i._getSoundIds(a), r = 0; r < o.length; r++) {
            ...
            if (n) {
                ...
                n._stereo = e,
                n._pos = [e, 0, 0],
                n._node && (n._pannerAttr.panningModel = "equalpower",
                n._panner && n._panner.pan || t(n, s),
                "spatial" === s ? n._panner.setPosition(e, 0, 0) : n._panner.pan.value = e),
                i._emit("stereo", n._id)
            }
        }
        return i
    }
    ...
    Howl.prototype.orientation = function(e, a, i, s) {
        ...
        for (var r = o._getSoundIds(s), n = 0; n < r.length; n++) {
            ...
            if (h) {
                ...
                h._orientation = [e, a, i],
                h._node && (h._panner || (h._pos || (h._pos = o._pos || [0, 0, -.5]),
                t(h, "spatial")),
                h._panner.setOrientation(e, a, i)),
    ...
    Howl.prototype.pannerAttr = function() {
        ...
        if (1 === o.length) {
            if ("object" != typeof o[0])
                return (i = s._soundById(parseInt(o[0], 10))) ? i._pannerAttr : s._pannerAttr;
            e = o[0],
            void 0 === a && (s._pannerAttr = {
        ...
        for (var r = s._getSoundIds(a), n = 0; n < r.length; n++)
            if (i = s._soundById(r[n])) {
                ...
                l.rolloffFactor = h.rolloffFactor) : (i._pos || (i._pos = s._pos || [0, 0, -.5]),
                t(i, "spatial"))
            }
        return s
    }
...
window.famobi.onRequest("changeVolume", (function(t) {
    masterVolume = t,
    muted || (sound._volume = masterVolume,
    "game" == gameState ? music.volume(.1 * masterVolume) : music.volume(.5 * masterVolume))
}
)),
window.famobi.started = !1,
window.famobi_game = {
    start: null
},
window.famobi.onRequest("startGame", (function() {
    window.famobi.started = !0,
    window.famobi.paused = !1,
    window.famobi_game.start && window.famobi_game.start()
}
)),
...
var player_hitType, enemy_hitType, masterVolume = window.famobi.getVolume(), player_serve = !0, forcedMode = window.famobi.hasFeature("forced_mode"), forcedModeProperties = {
    state: {},
    override: {}
}, won_matches_in_series_player = 0, won_matches_in_series_opponent = 0, points_in_series_player = 0, points_in_series_opponent = 0;
!function(t) {
    var e = function() {
        function t(t, e, a, i, s, o) {
            ...
            for (var r = 0; r < e.length; r++)
                -1 != e[r].file.indexOf(".json") ? this.loadJSON(e[r]) : this.loadImage(e[r]);
        ...
        t.prototype.loadExtraAssets = function(t, e) {
            ...
            for (var a = 0; a < e.length; a++)
                -1 != e[a].file.indexOf(".json") ? this.loadJSON(e[a]) : this.loadImage(e[a])
        }
        ,
        t.prototype.loadJSON = function(t) {
            ...
            a.onreadystatechange = function() {
                4 == a.readyState && 200 == a.status && (e.textData[t.id] = JSON.parse(a.responseText),
                ++e.assetsLoaded,
                e.checkLoadComplete())
            }
            ,
        ...
        t.prototype.loadImage = function(t) {
            ...
            a.onload = function() {
                ...
                0 != i[0] ? (e.oAssetData[t.id].oData.spriteWidth = i[0],
                e.oAssetData[t.id].oData.spriteHeight = i[1]) : (e.oAssetData[t.id].oData.spriteWidth = e.oAssetData[t.id].img.width,
                e.oAssetData[t.id].oData.spriteHeight = e.oAssetData[t.id].img.height),
                t.oAnims && (e.oAssetData[t.id].oData.oAnims = t.oAnims),
                t.oAtlasData ? e.oAssetData[t.id].oData.oAtlasData = t.oAtlasData : e.oAssetData[t.id].oData.oAtlasData = {
                    none: {
                        x: 0,
                        y: 0,
        ...
        t.prototype.getSpriteSize = function(t) {
            for (var e = new Array, a = "", i = "", s = 0, o = t.lastIndexOf("."), r = !0; r; )
                o--,
                0 == s && this.isNumber(t.charAt(o)) ? a = t.charAt(o) + a : 0 == s && a.length > 0 && "x" == t.charAt(o) ? (o--,
                s = 1,
                i = t.charAt(o) + i) : 1 == s && this.isNumber(t.charAt(o)) ? i = t.charAt(o) + i : 1 == s && i.length > 0 && "_" == t.charAt(o) ? (r = !1,
                e = [parseInt(i), parseInt(a)]) : (r = !1,
                e = [0, 0]);
            return e
        }
        ,
        ...
        t.prototype.checkLoadComplete = function() {
            this.totalAssets > 10 && window.famobi.setPreloadProgress(Math.round(this.assetsLoaded / this.totalAssets * 100)),
...
function(t) {
    var e = function() {
        function t(t, e) {
            ...
            t.addEventListener("touchstart", (function(t) {
                for (var e = 0; e < t.changedTouches.length; e++)
                    a.hitDown(t, t.changedTouches[e].pageX, t.changedTouches[e].pageY, t.changedTouches[e].identifier)
            }
            ), !1),
            t.addEventListener("touchend", (function(t) {
                for (var e = 0; e < t.changedTouches.length; e++)
                    a.hitUp(t, t.changedTouches[e].pageX, t.changedTouches[e].pageY, t.changedTouches[e].identifier)
            }
            ), !1),
            t.addEventListener("touchcancel", (function(t) {
                for (var e = 0; e < t.changedTouches.length; e++)
                    a.hitCancel(t, t.changedTouches[e].pageX, t.changedTouches[e].pageY, t.changedTouches[e].identifier)
            }
            ), !1),
            t.addEventListener("touchmove", (function(t) {
                for (var e = 0; e < t.changedTouches.length; e++)
                    a.move(t, t.changedTouches[e].pageX, t.changedTouches[e].pageY, t.changedTouches[e].identifier, !0)
            }
            ), !1),
            t.addEventListener("mousedown", (function(t) {
                a.isDown = !0,
                a.hitDown(t, t.pageX, t.pageY, 1)
            }
            ), !1),
            t.addEventListener("mouseup", (function(t) {
                a.isDown = !1,
                a.hitUp(t, t.pageX, t.pageY, 1)
            }
            ), !1),
            ...
            t.addEventListener("mouseout", (function(t) {
                a.isDown = !1,
                a.hitUp(t, Math.abs(t.pageX), Math.abs(t.pageY), 1)
            }
            ), !1),
        ...
        return t.prototype.hitDown = function(t, e, a, i) {
            ...
            !this.pauseIsOn && !window.famobi.paused) {
                    ...
                    if (this.aHitAreas[s].rect) {
                        ...
                        if (e > o + this.aHitAreas[s].area[0] && a > r + this.aHitAreas[s].area[1] && e < o + this.aHitAreas[s].area[2] && a < r + this.aHitAreas[s].area[3]) {
                            for (var n = 0; n < this.aHitAreas[s].aTouchIdentifiers.length; n++)
                                this.aHitAreas[s].aTouchIdentifiers[n] == i && (this.aHitAreas[s].aTouchIdentifiers.splice(n, 1),
                                n -= 1);
                            0 == this.aHitAreas[s].aTouchIdentifiers.length && (this.aHitAreas[s].oData.isDown = !1,
                            this.aHitAreas[s].oData.multiTouch && (this.aHitAreas[s].oData.x = e,
            ...
            if (!this.pauseIsOn && !window.famobi.paused) {
                if (!isMobile && null != userBat && !firstRun)
                    if (document.pointerLockElement === canvas || document.mozPointerLockElement === canvas) {
                        const {movementX: e, movementY: a} = t;
                        window.famobi.pointerLockHelper && (window.famobi.pointerLockHelper.mousePos.x + e < fenster.innerWidth && window.famobi.pointerLockHelper.mousePos.x + e > 0 && (window.famobi.pointerLockHelper.mousePos.x += e),
                        window.famobi.pointerLockHelper.mousePos.y + a < fenster.innerHeight && window.famobi.pointerLockHelper.mousePos.y + a > 0 && (window.famobi.pointerLockHelper.mousePos.y += a)),
                        ...
                        if (this.aHitAreas[o].rect) {
                            ...
                            if (e > r + this.aHitAreas[o].area[0] && a > n + this.aHitAreas[o].area[1] && e < r + this.aHitAreas[o].area[2] && a < n + this.aHitAreas[o].area[3])
                                ...
                                for (var h = 0; h < this.aHitAreas[o].aTouchIdentifiers.length; h++)
                                    this.aHitAreas[o].aTouchIdentifiers[h] == i && (this.aHitAreas[o].aTouchIdentifiers.splice(h, 1),
                                    h -= 1);
        ...
        t.prototype.keyDown = function(t) {
            for (var e = 0; e < this.aKeys.length; e++)
                t.keyCode == this.aKeys[e].keyCode && (t.preventDefault(),
                this.aKeys[e].oData.isDown = !0,
        ...
        t.prototype.removeKey = function(t) {
            for (var e = 0; e < this.aKeys.length; e++)
                this.aKeys[e].id == t && (this.aKeys.splice(e, 1),
                e -= 1)
        }
        ,
        ...
        t.prototype.removeHitArea = function(t) {
            for (var e = 0; e < this.aHitAreas.length; e++)
                this.aHitAreas[e].id == t && (this.aHitAreas.splice(e, 1),
                e -= 1)
        }
        ,
...
function(t) {
    var e = function() {
        function t() {
            ...
            (forcedModeProperties = window.famobi.getFeatureProperties("forced_mode")).state = forcedModeProperties.state || {},
        ...
        return t.prototype.renderGame = function() {
            ...
            e = this.oGameElementsImgData.oData.oAtlasData[oImageIds["tableBg" + this.wallId]].y,
            a = this.oGameElementsImgData.oData.oAtlasData[oImageIds["tableBg" + this.wallId]].width,
            i = this.oGameElementsImgData.oData.oAtlasData[oImageIds["tableBg" + this.wallId]].height;
    ...
    var e = function() {
        ...
        t.prototype.render = function(t) {
            ...
            case "start":
                ...
                e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBats].x,
                a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBats].y,
                i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBats].width,
                s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBats].height;
                ...
                e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBall].x,
                a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBall].y,
                i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBall].width,
                s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBall].height;
                ctx.drawImage(this.oUiElementsImgData.img, e, a, i, s, canvas.width / 2 - (i / 2 + 50) * o, .57 * canvas.height - (s / 2 + 50) * o - this.posY / 3, i * o, s * o);
                e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.globeLogo].x,
                a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.globeLogo].y,
                i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.globeLogo].width,
                s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.globeLogo].height;
                ctx.drawImage(this.oUiElementsImgData.img, e, a, i, s, canvas.width / 2 - i / 2, .2 * canvas.height - s / 2 + 80 - this.posY / 2, i, s);
                e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleLogo].x,
                a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleLogo].y,
            ...
            case "chooseCountry":
                for (var r = 0; r < countryFlags.aIds.length / 2; r++) {
                    ...
                    e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.countryBut].x,
                    a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.countryBut].y,
                    i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.countryBut].width,
                    s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.countryBut].height;
                ...
                var l = flagPage + 1
                  ...
                  , m = canvas.height - 28
                  , d = (o = .75,
                l * this.oSmallNumbersImgData.oData.spriteWidth % this.oSmallNumbersImgData.img.width)
                ...
                d = (l = 10) * this.oSmallNumbersImgData.oData.spriteWidth % this.oSmallNumbersImgData.img.width,
                c = Math.floor(l / (this.oSmallNumbersImgData.img.width / this.oSmallNumbersImgData.oData.spriteWidth)) * this.oSmallNumbersImgData.oData.spriteHeight;
                ...
                d = (l = 2) * this.oSmallNumbersImgData.oData.spriteWidth % this.oSmallNumbersImgData.img.width,
                c = Math.floor(l / (this.oSmallNumbersImgData.img.width / this.oSmallNumbersImgData.oData.spriteWidth)) * this.oSmallNumbersImgData.oData.spriteHeight;
                ...
                break;
            case "map":
                e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleFadeBar].x,
                a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleFadeBar].y,
                i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleFadeBar].width,
                s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleFadeBar].height;
                ctx.drawImage(this.oUiElementsImgData.img, e, a, i, s, 0, .5 * canvas.height - s / 2 + this.posY / 2, canvas.width, s);
                e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.map].x,
                a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.map].y,
                i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.map].width,
                s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.map].height;
                ...
                for (r = 0; r < aMapMarkerPos.length; r++) {
                    var g = canvas.width / 2 + aMapMarkerPos[r][0]
                      ...
                      , f = 0;
                    r < oGameData.cupId ? f = 2 : r == oGameData.cupId && (f = 1,
                    this.flare(g, p, .5));
                    e = this.oUiElementsImgData.oData.oAtlasData[oImageIds["mapMarker" + f]].x,
                    a = this.oUiElementsImgData.oData.oAtlasData[oImageIds["mapMarker" + f]].y,
                    i = this.oUiElementsImgData.oData.oAtlasData[oImageIds["mapMarker" + f]].width,
                    s = this.oUiElementsImgData.oData.oAtlasData[oImageIds["mapMarker" + f]].height;
                    ctx.drawImage(this.oUiElementsImgData.img, e, a, i, s, g - i / 2, p - s / 2, i, s);
                    for (var _ = (r + 1).toString(), I = 0; I < _.length; I++) {
                        o = .23,
                        d = (l = parseFloat(_.charAt(I))) * this.oLargeNumbersImgData.oData.spriteWidth % this.oLargeNumbersImgData.img.width,
                        c = Math.floor(l / (this.oLargeNumbersImgData.img.width / this.oLargeNumbersImgData.oData.spriteWidth)) * this.oLargeNumbersImgData.oData.spriteHeight;
                    ...
                    o = .5;
                    if (2 == f) {
                        e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].x,
                        a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].y,
                        i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].width,
                        s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].height;
                        ctx.drawImage(this.oUiElementsImgData.img, e, a, i, s, g - i / 2 * o + 26, p - s / 2 * o - 12, i * o, s * o)
                    } else if (1 == f) {
                        e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup2].x,
                        a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup2].y,
                        i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup2].width,
                        s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup2].height;
                        ctx.drawImage(this.oUiElementsImgData.img, e, a, i, s, g - i / 2 * o + 26, p - s / 2 * o - 12, i * o, s * o);
                        e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].x,
                        a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].y,
                        i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].width,
            ...
            case "gameIntro":
                ...
                i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBats].width,
                s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBats].height,
                o = Math.min(canvas.height / 3 / s, 1);
                ctx.drawImage(this.oUiElementsImgData.img, e, a, i, s, canvas.width / 2 - i / 2 * o, .3 * canvas.height - s / 2 * o - this.posY / 2, i * o, s * o);
                u = 22,
                m = 120,
                d = (l = oGameData.gameId + 1) * this.oSmallNumbersImgData.oData.spriteWidth % this.oSmallNumbersImgData.img.width,
                c = Math.floor(l / (this.oSmallNumbersImgData.img.width / this.oSmallNumbersImgData.oData.spriteWidth)) * this.oSmallNumbersImgData.oData.spriteHeight;
                ...
                d = (l = 6) * this.oSmallNumbersImgData.oData.spriteWidth % this.oSmallNumbersImgData.img.width,
                c = Math.floor(l / (this.oSmallNumbersImgData.img.width / this.oSmallNumbersImgData.oData.spriteWidth)) * this.oSmallNumbersImgData.oData.spriteHeight;
                ...
                o = .8,
                e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup0].x,
                ...
                if (ctx.drawImage(this.oUiElementsImgData.img, e, a, i, s, 5, 5 - this.posY / 2, i * o, s * o),
                this.cupFlipInc += 4 * delta,
                Math.floor(this.cupFlipInc) % 2 == 0) {
                    var v = 2
                      , D = (e = this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + v]].x,
                    a = this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + v]].y,
                    i = this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + v]].width,
                    s = this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + v]].height,
                    oGameData.gameId + 1);
                ...
                v = 3,
                e = this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + v]].x,
                a = this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + v]].y,
                i = this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + v]].width,
                s = this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + v]].height,
                D = oGameData.gameId;
                ...
                d = (l = 10) * this.oLargeNumbersImgData.oData.spriteWidth % this.oLargeNumbersImgData.img.width,
                c = Math.floor(l / (this.oLargeNumbersImgData.img.width / this.oLargeNumbersImgData.oData.spriteWidth)) * this.oLargeNumbersImgData.oData.spriteHeight;
                ...
                d = (l = oGameData.gameId + 1) * this.oLargeNumbersImgData.oData.spriteWidth % this.oLargeNumbersImgData.img.width,
                c = Math.floor(l / (this.oLargeNumbersImgData.img.width / this.oLargeNumbersImgData.oData.spriteWidth)) * this.oLargeNumbersImgData.oData.spriteHeight;
                ctx.drawImage(this.oLargeNumbersImgData.img, d, c, this.oLargeNumbersImgData.oData.spriteWidth, this.oLargeNumbersImgData.oData.spriteHeight, canvas.width / 2 - this.oLargeNumbersImgData.oData.spriteWidth / 2 + this.largeNumberSpace / 2, .2 * canvas.height - this.oLargeNumbersImgData.oData.spriteHeight / 2 - this.posY, this.oLargeNumbersImgData.oData.spriteWidth, this.oLargeNumbersImgData.oData.spriteHeight);
                e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.vsText].x,
                a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.vsText].y,
                i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.vsText].width,
                s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.vsText].height;
                ctx.drawImage(this.oUiElementsImgData.img, e, a, i, s, canvas.width / 2 - i / 2, .6 * canvas.height - s / 2 - this.posY / 4, i, s);
                h = countryFlags.getBData(oGameData.userId),
                o = 1.2;
            ...
            case "game":
                let t = !0
                  , x = !0;
                if (null != forcedModeProperties && null != forcedModeProperties.override && Array.isArray(forcedModeProperties.override.hide_ui) && (t = !forcedModeProperties.override.hide_ui.includes("score"),
                x = !forcedModeProperties.override.hide_ui.includes("flags")),
                t) {
                    e = this.oGameElementsImgData.oData.oAtlasData[oImageIds.scoreCard].x,
                    a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.scoreCard].y,
                    i = this.oGameElementsImgData.oData.oAtlasData[oImageIds.scoreCard].width,
                    s = this.oGameElementsImgData.oData.oAtlasData[oImageIds.scoreCard].height;
                    ...
                    for (r = 0; r < y.length; r++) {
                        d = (l = parseFloat(y.charAt(r))) * this.oScoreNumbersImgData.oData.spriteWidth % this.oScoreNumbersImgData.img.width,
                        c = Math.floor(l / (this.oScoreNumbersImgData.img.width / this.oScoreNumbersImgData.oData.spriteWidth)) * this.oScoreNumbersImgData.oData.spriteHeight;
                    ...
                    for (y = oGameData.enemyScore.toString(),
                    r = 0; r < y.length; r++) {
                        d = (l = parseFloat(y.charAt(r))) * this.oScoreNumbersImgData.oData.spriteWidth % this.oScoreNumbersImgData.img.width,
                        c = Math.floor(l / (this.oScoreNumbersImgData.img.width / this.oScoreNumbersImgData.oData.spriteWidth)) * this.oScoreNumbersImgData.oData.spriteHeight;
                ...
                if (firstRun) {
                    ...
                    ctx.fillRect(0, 0, canvas.width, canvas.height);
                    e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.tutScreen].x,
                    a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.tutScreen].y,
                    i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.tutScreen].width,
                    s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.tutScreen].height;
                    ...
                    ctx.scale(o, o);
                    e = this.oGameElementsImgData.oData.oAtlasData[oImageIds["enemyBat" + b]].x,
                    a = this.oGameElementsImgData.oData.oAtlasData[oImageIds["enemyBat" + b]].y,
                    i = this.oGameElementsImgData.oData.oAtlasData[oImageIds["enemyBat" + b]].width,
                    s = this.oGameElementsImgData.oData.oAtlasData[oImageIds["enemyBat" + b]].height;
                    if (ctx.drawImage(this.oGameElementsImgData.img, e, a, i, s, -i / 2, -s / 3, i, s),
                    ctx.restore(),
                    o = .4,
                    this.ballY < 20) {
                        e = this.oGameElementsImgData.oData.oAtlasData[oImageIds.ballShadow].x,
                        a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.ballShadow].y,
                        i = this.oGameElementsImgData.oData.oAtlasData[oImageIds.ballShadow].width,
                    ...
                    o = .4;
                    e = this.oGameElementsImgData.oData.oAtlasData[oImageIds.ball].x,
                    a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.ball].y,
                    i = this.oGameElementsImgData.oData.oAtlasData[oImageIds.ball].width,
                    ...
                    i = this.oGameElementsImgData.oData.oAtlasData[oImageIds["enemyBat" + b]].width,
                    s = this.oGameElementsImgData.oData.oAtlasData[oImageIds["enemyBat" + b]].height;
                    ctx.drawImage(this.oGameElementsImgData.img, e, a, i, s, -i / 2, -s / 2, i, s),
                    ctx.restore(),
                    o = .4;
                    e = this.oGameElementsImgData.oData.oAtlasData[oImageIds.finger].x,
                    a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.finger].y,
                    i = this.oGameElementsImgData.oData.oAtlasData[oImageIds.finger].width,
                    s = this.oGameElementsImgData.oData.oAtlasData[oImageIds.finger].height;
            ...
            case "gameComplete":
                ...
                i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleFadeBar].width,
                s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleFadeBar].height;
                if (ctx.drawImage(this.oUiElementsImgData.img, e, a, i, s, 0, .55 * canvas.height - s / 2 + this.posY / 2, canvas.width, s),
                justWonCup) {
                    if (!forcedMode) {
                        e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].x,
                        a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].y,
                    ...
                    if (!forcedMode) {
                        ...
                        u = 22,
                        m = 120,
                        d = (l = oGameData.gameId) * this.oSmallNumbersImgData.oData.spriteWidth % this.oSmallNumbersImgData.img.width,
                        c = Math.floor(l / (this.oSmallNumbersImgData.img.width / this.oSmallNumbersImgData.oData.spriteWidth)) * this.oSmallNumbersImgData.oData.spriteHeight;
                        ctx.drawImage(this.oSmallNumbersImgData.img, d, c, this.oSmallNumbersImgData.oData.spriteWidth, this.oSmallNumbersImgData.oData.spriteHeight, u, m - this.posY / 2, this.oSmallNumbersImgData.oData.spriteWidth, this.oSmallNumbersImgData.oData.spriteHeight);
                        d = (l = 10) * this.oSmallNumbersImgData.oData.spriteWidth % this.oSmallNumbersImgData.img.width,
                        c = Math.floor(l / (this.oSmallNumbersImgData.img.width / this.oSmallNumbersImgData.oData.spriteWidth)) * this.oSmallNumbersImgData.oData.spriteHeight;
                    ...
                    e = this.oUiElementsImgData.oData.oAtlasData[w].x,
                    a = this.oUiElementsImgData.oData.oAtlasData[w].y,
                    i = this.oUiElementsImgData.oData.oAtlasData[w].width,
                    s = this.oUiElementsImgData.oData.oAtlasData[w].height;
                    ctx.drawImage(this.oUiElementsImgData.img, e, a, i, s, canvas.width / 2 - i / 2, .2 * canvas.height - s / 2 - this.posY, i, s)
                }
                e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.globeLogo].x,
                a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.globeLogo].y,
                ...
                for (y = oGameData.userScore.toString(),
                r = 0; r < y.length; r++) {
                    d = (l = parseFloat(y.charAt(r))) * this.oLargeNumbersImgData.oData.spriteWidth % this.oLargeNumbersImgData.img.width,
                    c = Math.floor(l / (this.oLargeNumbersImgData.img.width / this.oLargeNumbersImgData.oData.spriteWidth)) * this.oLargeNumbersImgData.oData.spriteHeight;
                ...
                d = (l = 12) * this.oLargeNumbersImgData.oData.spriteWidth % this.oLargeNumbersImgData.img.width,
                c = Math.floor(l / (this.oLargeNumbersImgData.img.width / this.oLargeNumbersImgData.oData.spriteWidth)) * this.oLargeNumbersImgData.oData.spriteHeight;
        ...
        t.prototype.flare = function(t, e, a) {
            ...
            ctx.drawImage(this.oUiElementsImgData.img, s, o, r, n, -r / 2, -n / 2, r, n),
        ...
        t.prototype.addButs = function(t) {
            for (var e = 0; e < this.aButs.length; e++) {
                var a = this.posY
                  , i = 0;
                0 == this.incY || this.aButs[e].noMove || (i = 3 * Math.sin(this.incY + 45 * e)),
                this.aButs[e].scale || (this.aButs[e].scale = 1);
    ...
    var e = function() {
        ...
        t.prototype.getHitData = function(t, e) {
            ...
            var a = Math.max(Math.min((this.x - this.prevX) / delta, 3500), -3500) / 3500
              ...
              , s = 0;
            if (i < .5 && (a > .5 ? s = -2 * (a - .5) * (1 - 2 * i) : a < -.5 && (s = -2 * (a + .5) * (1 - 2 * i))),
            a *= t < 0 ? a > 0 ? 1 - t / 1 : 1.2 : a < 0 ? 1 + t / 1 : 1.2,
            0 == ball.servingState && (a *= .5),
            this.hitX = a + .8 * t,
            this.hitY = .4 * (1 - i),
            null != forcedModeProperties && null != forcedModeProperties.override && forcedModeProperties.override.curve_mode) {
                let t = .5;
                "number" == typeof forcedModeProperties.override.curve_strength && (t = forcedModeProperties.override.curve_strength),
                s = -2 * (a + t * (a > 0 ? 1 : -1)) * (1 - 2 * i)
            }
        ...
        t.prototype.render = function() {
            ...
            ctx.drawImage(this.oGameElementsImgData.img, t, e, a, i, -a / 2, -i / 3, a, i),
            ctx.rotate(-this.rotation),
            ...
            e = this.oGameElementsImgData.oData.oAtlasData[oImageIds.userBatEdge].y,
            a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.userBatEdge].width,
            i = this.oGameElementsImgData.oData.oAtlasData[oImageIds.userBatEdge].height;
            ctx.drawImage(this.oGameElementsImgData.img, t, e, a, i, -a / 2, -i / 3 - 23, a, i),
            ctx.restore()
        }
        ,
        t
...
function(t) {
    var e = function() {
        ...
        t.prototype.update = function() {
            window.famobi.paused || (this.y = this.targY + canvas.height / 4 + 50 * tableTop.offsetY - 45,
        ...
        t.prototype.getHitData = function(t, e) {
            ...
            var a = 0;
            if (this.hitY < .8 && (this.hitX > .1 ? a = -1 * Math.random() * (.75 + .25 * this.skillLevel) : this.hitX < -.1 && (a = 1 * Math.random() * (.75 + .25 * this.skillLevel))),
            null != forcedModeProperties && null != forcedModeProperties.override && forcedModeProperties.override.curve_mode) {
                let t = 1;
                "number" == typeof forcedModeProperties.override.curve_strength && (t = forcedModeProperties.override.curve_strength),
                a = (2 * Math.random() - 1) * (.75 + .25 * this.skillLevel) * t
            }
...
function(t) {
    var e = function() {
        ...
        return t.prototype.resetServe = function(t) {
            ...
            this.tableVX = 0,
            this.tableVY = 0,
            player_serve = !0) : (this.tablePosX = 0,
            this.tablePosY = .2,
            this.height = 15,
            this.heightInc = 0,
            this.aTrailPoints = new Array),
        ...
        t.prototype.update = function() {
            if (!window.famobi.paused)
                if (0 == this.servingState)
                    ...
                    0 != userBat.getHitData(this.tablePosX, this.tablePosY).spin ? (window.famobi_analytics.trackStats("ball_hit", {
                        hit_type: "curvedBall"
                    }),
                    ...
                    player_hitType = "powerBall") : (window.famobi_analytics.trackStats("ball_hit"),
                    player_hitType = "")),
                    ...
                    enemy_hitType = 0 != enemyBat.getHitData(this.tablePosX, this.tablePosY).spin ? "curvedBall" : enemyBat.getHitData(this.tablePosX, this.tablePosY).speed >= .5 ? "powerBall" : "")
                }
        }
        ,
        t.prototype.render = function() {
            ...
            a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.ball].width,
            i = this.oGameElementsImgData.oData.oAtlasData[oImageIds.ball].height;
            ctx.drawImage(this.oGameElementsImgData.img, t, e, a, i, this.x - a / 2 * this.scale, this.y - i / 2 * this.scale - this.height * (3 * this.scale) - 16, a * this.scale, i * this.scale),
...
function(t) {
    var e = function() {
        ...
        t.prototype.tweenToPos = function(t, e, a, i, s) {
            ...
            "enemy" == i && (n = .5,
            r = (1 - 2 * (e - .5)) * (.3 - (a - .3)) / .3),
            this.offsetTween = TweenLite.to(this, n, {
                offsetX: o,
                offsetY: r,
                ease: "Quad.easeOut"
            })
        ...
        t.prototype.render = function() {
            ...
            ctx.drawImage(this.oGameElementsImgData.img, e, a, i, t, canvas.width / 2 - i / 2 * (1 + this.offsetY / 3) + this.offsetX * (.282 * this.segs) * 3 * (1 + this.offsetY / 3) + this.offsetX * this.sideMultiplier, this.netY + this.netHeight - 3 * (1 + this.offsetY / 3), i * (1 + this.offsetY / 3), t * (1 + this.offsetY / 3)),
            ...
            e = this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableLegs].x,
            a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableLegs].y,
            i = this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableLegs].width,
            ...
            e = this.oGameElementsImgData.oData.oAtlasData[oImageIds["table" + this.id]].x,
            a = this.oGameElementsImgData.oData.oAtlasData[oImageIds["table" + this.id]].y,
            i = this.oGameElementsImgData.oData.oAtlasData[oImageIds["table" + this.id]].width,
            t = this.oGameElementsImgData.oData.oAtlasData[oImageIds["table" + this.id]].height;
            for (var s = 0; s < this.segs; s++)
                ctx.drawImage(this.oGameElementsImgData.img, e, a + t / this.segs * s, i, t / this.segs, canvas.width / 2 - i / 2 * (1 + this.offsetY / 3) + this.offsetX * (s * (100 / this.segs)) * 3 * (1 + this.offsetY / 3) + this.offsetX * this.sideMultiplier, canvas.height / 4 + t / this.segs * s * (1 + this.offsetY / 2) + 50 * this.offsetY, i * (1 + this.offsetY / 3), t / this.segs * (1 + this.offsetY / 2));
            e = this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableEdge].x,
            a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableEdge].y,
            i = this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableEdge].width,
            t = this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableEdge].height;
            if (ctx.drawImage(this.oGameElementsImgData.img, e, a, i, t, canvas.width / 2 - i / 2 * (1 + this.offsetY / 3) + 100 * this.offsetX * 3 * (1 + this.offsetY / 3) + this.offsetX * this.sideMultiplier, canvas.height / 4 + this.oGameElementsImgData.oData.oAtlasData[oImageIds.table0].height * (1 + this.offsetY / 2) + 50 * this.offsetY, i * (1 + this.offsetY / 3), t * (1 + this.offsetY / 3)),
            this.bounceMarkScale > 0) {
                e = this.oGameElementsImgData.oData.oAtlasData[oImageIds.bounceMark].x,
                a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.bounceMark].y,
                i = this.oGameElementsImgData.oData.oAtlasData[oImageIds.bounceMark].width,
        ...
        t.prototype.getLineWidths = function(t) {
            for (var e, a = new Array, i = 0; i < t.length; i++) {
                ...
                for (var s = 0; s < t[i].length; s++)
                    ...
                    0 == s ? e -= parseInt(t[i][s]["@xoffset"]) : s == t[i].length - 1 && (e += parseInt(t[i][s]["@xoffset"]));
                a.push(e)
            }
            return a
        }
            ...
            for (var a = new Array, i = 0; i < t.length; i++) {
                ...
                for (var s = 0; s < t[i].length; s++)
                    for (var o = 0; o < assetLib.textData["fontData" + e].text.chars.char.length; o++)
                        t[i][s].charCodeAt() == assetLib.textData["fontData" + e].text.chars.char[o]["@id"] && a[i].push(assetLib.textData["fontData" + e].text.chars.char[o])
            }
            return a
        }
        ,
        t.prototype.renderText = function(t) {
            var e, a = this.oTextData[t.text].aLineData, i = this.oTextData[t.text].oFontImgData, s = 0, o = 0, r = 0, n = 1, h = 0;
            t.lineOffsetY && (r = t.lineOffsetY),
            t.scale && (n = t.scale);
            var l = 1 * n;
            t.maxWidth && this.oTextData[t.text].blockWidth * n > t.maxWidth && (l = t.maxWidth / this.oTextData[t.text].blockWidth),
            t.anim && (this.inc += 7 * delta);
            for (var u = 0; u < a.length; u++) {
                e = 0,
                "centre" == t.alignX && (s = this.oTextData[t.text].aLineWidths[u] / 2),
                "centre" == t.alignY && (o = this.oTextData[t.text].blockHeight / 2 + r * (a.length - 1) / 2);
                for (var m = 0; m < a[u].length; m++) {
                    var d = a[u][m]["@x"]
                      , c = a[u][m]["@y"]
                      , g = a[u][m]["@width"]
                      , p = a[u][m]["@height"];
                    t.anim && (h = Math.sin(this.inc + m / 2) * (p / 15 * l)),
                    ctx.drawImage(i.img, d, c, g, p, t.x + (e + parseInt(a[u][m]["@xoffset"]) - s) * l, t.y + (parseInt(a[u][m]["@yoffset"]) + u * this.oTextData[t.text].lineHeight + u * r - o) * l + h, g * l, p * l),
...
!function(t) {
    var e = function(t) {
        ...
        e.prototype.update = function(e, a) {
            this.vy += 150 * delta,
    ...
    var e = function() {
        ...
        t.prototype.getCurCupId = function() {
            for (var t = 0, e = 0; e < 10; e++)
                7 == this.aLevelStore[e] && t++;
            return t
        }
        ,
        t.prototype.getCurGameId = function() {
            for (var t = 0, e = 0; e < 10; e++)
                0 != this.aLevelStore[e] && (t = this.aLevelStore[e] - 1);
            return t
        }
        ,
        t.prototype.setGameData = function(t) {
            for (var e = 0; e < 10; e++)
                e < t.cupId ? this.aLevelStore[e] = 7 : e == t.cupId ? this.aLevelStore[e] = t.gameId + 1 : this.aLevelStore[e] = 0
        }
        ,
        t.prototype.saveData = function() {
            for (var t = "", e = 0; e < this.aLevelStore.length; e++)
                t += this.aLevelStore[e],
                e < this.aLevelStore.length - 1 && (t += ",");
...
function initSplash() {
    ...
    if (1234 == t ? firstRun = !0 : (firstRun = !1,
    oGameData.userId = t),
    ...
    forcedMode) {
        ...
        null != t && null != t.state && ((forcedModeProperties = t).state = forcedModeProperties.state || {},
        forcedModeProperties.override = forcedModeProperties.override || {});
...
function initStartScreen() {
    if (background = new Elements.Background,
    forcedMode)
        return initGameIntro(),
    ...
    if (skipTitle)
        ...
        1 == audioType && music.fade(music.volume(), .5 * masterVolume, 500),
        ...
        userInput.addHitArea("credits", butEventHandler, null, "image", a);
...
function addMuteBut(t) {
    if (!externalMute && 1 == audioType) {
        ...
        userInput.addHitArea("mute", butEventHandler, null, "image", a),
        t.push(a)
    }
}
function initCreditsScreen() {
    ...
    userInput.addHitArea("control0FromCredits", butEventHandler, null, "image", a),
    userInput.addHitArea("control1FromCredits", butEventHandler, null, "image", i),
    s.push(a, i));
    addMuteBut(s),
...
function initChooseCountry() {
    ...
    void 0 === background && (background = new Elements.Background);
    var t = {
        oImgData: assetLib.getData("uiButs"),
        aPos: [30, -32],
        align: [0, 1],
      ...
      , e = new Array;
    if (0 == flagPage && skipTitle || (e = new Array(t),
    ...
    0 == flagPage) {
        ...
        userInput.addHitArea("moreFromChooseCountry", butEventHandler, null, "image", a),
        e.push(a)
    }
...
function initMapScreen() {
    ...
    userInput.addHitArea("backFromMap", butEventHandler, null, "image", i),
    userInput.addHitArea("playFromMap", butEventHandler, null, "image", s);
    var o = new Array(i,s);
...
function initGameIntro() {
    ...
    oGameData.gameId = 5),
    forcedMode || (oGameData.enemyId = countryFlags.getIdFromISO(aEnemyCountries[oGameData.cupId][oGameData.gameId]),
    ...
    userInput.addHitArea("playFromGameIntro", butEventHandler, null, "image", e);
    var a = new Array(t,e);
    addMuteBut(a),
...
function _initGame() {
    ...
    if (firstRun) {
        ...
        externalPause || window.famobi.pointerLockHelper || (userInput.addHitArea("pause", butEventHandler, null, "image", a),
        t.push(a))
    }
    window.famobi.pointerLockHelper || addMuteBut(t),
    (panel = new Elements.Panel(gameState,t)).startTween1(),
    ...
    window.famobi_game.start = function() {
        ...
        1 == audioType && music.fade(music.volume(), .1 * masterVolume, 1e3)
    }
    ,
    window.famobi.paused = !0,
    window.externalStart && !window.famobi.started || (window.famobi.paused = !1,
...
function initPause() {
    ...
    userInput.addHitArea("restartFromPause", butEventHandler, null, "image", e),
    ...
    userInput.addHitArea("control0FromPause", butEventHandler, null, "image", i),
    userInput.addHitArea("control1FromPause", butEventHandler, null, "image", s),
    o.push(i, s));
    (panel = new Elements.Panel(gameState,o)).startTween1(),
    previousTime = (new Date).getTime(),
    background = new Elements.Background,
...
function resumeGame() {
    ...
    var t = {
      ...
      , e = new Array;
    externalPause || (userInput.addHitArea("pause", butEventHandler, null, "image", t),
    e = new Array(t)),
    addMuteBut(e),
    (panel = new Elements.Panel(gameState,e)).startTween1(),
    previousTime = (new Date).getTime(),
...
function butEventHandler(t, e) {
    if (!window.famobi.paused)
        ...
        case "resetData":
            ...
            oGameData.cupId = saveDataHandler.getCurCupId(),
            oGameData.gameId = saveDataHandler.getCurGameId(),
            1234 == (a = saveDataHandler.getUserId()) ? firstRun = !0 : (firstRun = !1,
            oGameData.userId = a),
            controlState = saveDataHandler.getControlState(),
            initStartScreen();
            break;
        ...
        case "countryChoice":
            ...
            oGameData.userId = countryFlags.aIds[e.id],
        ...
        case "tickFromTut":
            ...
            externalPause || (userInput.addHitArea("pause", butEventHandler, null, "image", i),
            panel.aButs.push(i)),
            firstRun = !1;
            break;
        case "gameTouch":
            e.isDown && !e.isBeingDragged ? (swipeState = 1,
            startTouchY = e.y - userBat.targY) : 1 == swipeState && e.isBeingDragged ? (userBat.targX = e.x,
            userBat.targY = 0 == controlState ? e.y : e.y - startTouchY) : 1 == swipeState && (swipeState = 0);
            break;
        ...
        case "nextFromGameComplete":
            ...
            userInput.removeHitArea("backFromGameComplete"),
            userInput.removeHitArea("nextFromGameComplete"),
            10 == oGameData.cupId && 6 == oGameData.gameId ? initMapScreen() : oGameData.userScore > oGameData.enemyScore ? 0 == oGameData.gameId ? initMapScreen() : initGameIntro() : initGame(!0);
            break;
        case "mute":
            playSound("hit" + Math.floor(6 * Math.random())),
            toggleMute(),
        ...
        case "disableAudio":
            ...
            break;
        case "pause":
            !0 !== e && playSound("hit" + Math.floor(6 * Math.random())),
        ...
        case "quitFromPause":
            ...
            1 == audioType ? (muted || (Howler.mute(!1),
            playMusic()),
            music.fade(music.volume(), .5 * masterVolume, 500)) : 2 == audioType && (muted || playMusic()),
            userInput.removeHitArea("quitFromPause"),
            userInput.removeHitArea("playFromPause"),
            userInput.removeHitArea("restartFromPause"),
            userInput.removeHitArea("control0FromPause"),
...
function updateScore(t, e) {
    ...
    let a = 11;
    null != forcedModeProperties && null != forcedModeProperties.override && "number" == typeof forcedModeProperties.override.max_score && (a = forcedModeProperties.override.max_score),
    ...
    playSound("userPoint"),
    (oGameData.userScore >= a && (a < 2 || oGameData.enemyScore <= oGameData.userScore - 2) || 99 == oGameData.userScore) && initGameComplete()) : (oGameData.enemyScore++,
    window.famobi_analytics.trackStats("point_scored", {
    ...
    (oGameData.enemyScore >= a && (a < 2 || oGameData.userScore <= oGameData.enemyScore - 2) || 99 == oGameData.enemyScore) && initGameComplete())
}
function initGameComplete() {
    oGameData.userScore > oGameData.enemyScore ? (won_matches_in_series_opponent = 0,
    won_matches_in_series_player++) : (won_matches_in_series_player = 0,
    won_matches_in_series_opponent++);
    let t = oGameData.userScore > oGameData.enemyScore ? "success" : "fail";
    oGameData.userScore == oGameData.enemyScore && (t = "draw"),
...
function _initGameComplete() {
    ...
    var t, e = {
        ...
        userInput.addHitArea("backFromGameComplete", butEventHandler, null, "image", e)
    };
...
function getCentreFromTopLeft(t, e, a) {
    var i = new Array;
    return i.push(t[0] + e.oData.spriteWidth / 2 * a),
    i.push(t[1] + e.oData.spriteHeight / 2 * a),
    i
}
function loadPreAssets() {
    if (aLangs.length > 1) {
        for (var t = new Array, e = 0; e < aLangs.length; e++)
            t.push({
                id: "lang" + aLangs[e],
...
function initLangSelect() {
    for (var t, e, a, i, s = 0, o = 0; o < aLangs.length && (o + 1) * (1 * (t = preAssetLib.getData("lang" + aLangs[o])).img.width) + 10 * (o + 2) < canvas.width; o++)
        s++;
...
function resizeCanvas() {
    ...
    t > e ? canvas.height < minSquareSize ? (canvas.height = minSquareSize,
    canvas.width = minSquareSize * (t / e),
    canvasScale = minSquareSize / e) : canvas.height > maxSquareSize ? (canvas.height = maxSquareSize,
    canvas.width = maxSquareSize * (t / e),
    canvasScale = maxSquareSize / e) : canvasScale = 1 : canvas.width < minSquareSize ? (canvas.width = minSquareSize,
